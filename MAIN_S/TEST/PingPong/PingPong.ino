...
/*Функция, которая будет выполнена при событии тайм-аута радиопередачи
 */
void OnTxTimeout(void)
{
	// Radio.Sleep();
...
/** Функция, которая должна быть выполнена при событии Radio Rx Timeout
 */
void OnRxTimeout(void)
{
...
/**краткая Функция, которая будет выполнена при событии CAD Done
 */
void OnCadDone(bool cadResult)
{
