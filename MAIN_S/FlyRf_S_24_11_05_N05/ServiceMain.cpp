...
void ServiceClass::saveMessageRead(bool On_Message)
{
...
void ServiceClass::saveAllow_flashing(bool On_Off)
{
	flashing = On_Off;
}
...
void ServiceClass::saveMailOn(bool On_Off)
{
	flags_MailOn = On_Off;
}
...
void ServiceClass::save_confirm_message(bool On_Off)
{
