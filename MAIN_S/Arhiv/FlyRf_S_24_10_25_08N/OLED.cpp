...
const char FlyRF_text1[]  = "FlyRF";
const char FlyRF_text2[]  = "and";
const char FlyRF_text3[]  = "Decima";
...
#if defined(ENABLE_OLED_TEXT_PAGE)
    if (hw_info.display   == DISPLAY_OLED_HELTEC &&  OLED_current_page == OLED_PAGE_TEXT/* &&  (settings->power_save & POWER_SAVE_NORECEIVE)*/ && (hw_info.rf == RF_IC_SX1276 ||hw_info.rf == RF_IC_SX1262))
    {
      OLED_current_page = (OLED_current_page + 1) % page_count;
    }
#endif /* ENABLE_OLED_TEXT_PAGE */
