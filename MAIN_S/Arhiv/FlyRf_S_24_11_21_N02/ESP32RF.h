...
#define SOC_GPIO_PIN_LORA_TXE    41 //”Ô‡‚ÎÂÌËÂ PA LoRa
#define SOC_GPIO_PIN_LORA_RXE    42 //”Ô‡‚ÎÂÌËÂ PA LoRa

#define SOC_GPIO_PIN_LED         4 
...
static void waiting_txt(void); // ¬˚‚Ó‰ ÚÂÍÒÚ‡ "Œœ–≈ƒ≈À≈Õ»≈ Ã≈—“ŒœŒÀŒ∆≈Õ»ﬂ"
