...
#define SOC_GPIO_PIN_TRACKER_RX    38
#define SOC_GPIO_PIN_TRACKER_TX    39
...
/*BasicMAC Ч это переносима€ реализаци€ спецификации LoRaWANЩ от LoRaЩ Alliance на €зыке программировани€ C.
Ёто ответвление библиотеки LMiC от IBM, которое поддерживает несколько регионов, выбираемых во врем€ компил€ции и/или выполнени€.
ќно может работать с устройствами класса A, класса B и класса C.*/
#define USE_BASICMAC
...
static void waiting_txt(void); // ¬ывод текста "ќѕ–≈ƒ≈Ћ≈Ќ»≈ ћ≈—“ќѕќЋќ∆≈Ќ»я"
