    ...
    if (TxPosUpdMarker == 0 || (millis() - TxPosUpdMarker) > 2000)
    {
        ...
        case 4:
            ...
            */
            ...
            {
            case 0:
                alien_lat20 -= (alien_lat13 - alien_lat14) / 20; // ������������ ������ ����
            ...
            case 1:
                alien_lat20 = alien_lat14;
                alien_lon20 -= (alien_lon14 - alien_lon15) / 20; // ������������ ����� ������ ������
                ...
                break;
            case 2:
                alien_lat20 += (alien_lat16 - alien_lat15) / 20; // ������������ ����� �����
                alien_lon20 = alien_lon15;//
            ...
            case 3:
                ...
                // ������������ ����� ������� � �������� �����
                alien_lat20 = alien_lat16;
                alien_lon20 += (alien_lon13 - alien_lon16) / 20; // ������������ ����� ������ ������
            ...
            fo.aircraft_type = AIRCRAFT_TYPE_JET;
            /* ������ ����������, ����� � ������ ���������� ��������� ������ � ���������� ��������*/
            if (fo.latitude != 0.0 && fo.longitude != 0.0) // ������ �������� ���� �������� ���������� ������ � ���������� ��������
            {
                Traffic_Update(&fo);   // 
            }
        ...
        case 5:
            ...
            case 0:
                ...
                */
                alien_lat30 -= (alien_lat23 - alien_lat24) / 20; // ������������ ������ ����
            ...
            case 1:
                ...
                break;
            case 2:
                alien_lat30 += (alien_lat26 - alien_lat25) / 20; // ������������ ����� �����
                alien_lon30 = alien_lon25;//
