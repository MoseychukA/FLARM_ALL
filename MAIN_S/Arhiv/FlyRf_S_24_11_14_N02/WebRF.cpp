...
//</tr>\
//<tr>\
//<th align=left>Модуль LoRa</th>\
//<td align=right>\
//<select name='lora_module'>\
//<option %s value='%d'>LoRa Off</option>\
//<option %s value='%d'>LORA SX1276</option>\
//<option %s value='%d'>LORA SX1262</option>\
//<option %s value='%d'>LORA SX1262 LLCC68(1вт.)</option>"),
//(settings->lora_module == LORA_OFF ? "selected" : ""), LORA_OFF,
//(settings->lora_module == LORA_SX1276 ? "selected" : ""), LORA_SX1276,
//(settings->lora_module == LORA_SX1262 ? "selected" : ""), LORA_SX1262,
//(settings->lora_module == SX1262_LLCC68 ? "selected" : ""), SX1262_LLCC68);
//
//  len = strlen(offset);
//  offset += len;
//  size -= len;

  /* Radio specific part 7 */
...
<body>\
 ...
 "</table><table width=100%%>\
  ...
  "</table><table width=100%%>\
  <tr><th align=left>Протокол</th><td align=right>%s</td></tr>\
  <tr><th align=left>Регион</th><td align=right>%s</td></tr></table></td></tr>"
  "</table><table width=100%%>\
 ...
 <table width=100%%>\
  <tr><th align=left>Датчик давления(м)</th><td align=right>%d</td></tr>\
...
<tr><th align=left>RAM view</th><td align=right>%d</td></tr>\
...
<hr>\
 <p align=center><h2 align=center>Выполняется перезагрузка... Пожалуйста, подождите!</h2></p>\
  ...
  settings->rssi_view, settings->ram_view, settings->gsm_send,
  settings->bluetooth,
