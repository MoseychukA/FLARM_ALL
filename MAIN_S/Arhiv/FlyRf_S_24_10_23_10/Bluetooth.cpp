  ...
  case BLUETOOTH_LE_HM10_SERIAL:
    {
      ...
      const char *Model         = hw_info.model == FLYRF_MODEL_STANDALONE ? "Standalone Edition" :
                                  hw_info.model == FLYRF_MODEL_PRIME_MK2  ? "Prime Mark II"      :
                                  hw_info.model == FLYRF_MODEL_PRIME_MK3  ? "Prime Mark III"     :
                                  hw_info.model == FLYRF_MODEL_HAM        ? "Ham Edition"        :
                                  hw_info.model == FLYRF_MODEL_MIDI       ? "Midi Edition"       :
                                  "Unknown";
      char SerialNum[9];
      ...
      const char *Manufacturer  = FLYRF_IDENT;
...
void nRF52_Bluetooth_setup()
{
  ...
  bledis.setSoftwareRev(FLYRF_FIRMWARE_VERSION);
  bledis.begin();
...
//      l2cap_set_max_le_mtu(26);
      ...
      device_information_service_server_set_software_revision(FLYRF_FIRMWARE_VERSION);
