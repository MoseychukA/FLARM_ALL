...
/*
инициализация кодировки adsb
*/
void adsb_encoder_init(); 


/*
Генерировать сообщение о воздушном положении
*/
...
frame_data_t  make_surface_position_frame(
	...
	unsigned int knot, //Скорость относительно земли (узлы)
...
/*
Генерация сообщения классификации личности
*/
...
/*
Генерация сообщения о путевой скорости
*/
frame_data_t make_velocity_frame(
	...
	double vrate,  //Скорость подъема (футы/мин, положительное направление подъема)
	DF df); 
