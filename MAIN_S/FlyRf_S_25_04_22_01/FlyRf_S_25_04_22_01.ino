...
void txrx_test()
{
    ...
    else if (set_auto_coordinate == false && settings->input_coordinates == IMPUT_COORD_MANUAL)
    {
        ...
        float lat_tmp = settings->test_latitude;
        float lat_tmpM = settings->test_latitude / 1000000;

        ThisAircraft.test_latitude = lat_tmp+ lat_tmpM;
        ThisAircraft.test_longitude = 0;
        set_auto_coordinate = true;
    }
