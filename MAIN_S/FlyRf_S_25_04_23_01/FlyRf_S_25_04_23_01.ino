...
void txrx_test()
{
    ...
    {
        ThisAircraft.test_latitude = (float)settings->test_latitude + ((float)settings->test_latitudeM / (float)1000000);
        ThisAircraft.test_longitude = (float)settings->test_longitude + ((float)settings->test_longitudeM / (float)1000000);
        set_auto_coordinate = true;
    }
