...
float alien_lat2 = 55.950197;
float alien_lon2 = 38.207984;
...
void txrx_test()
{
    ...
    if (TxPosUpdMarker == 0 || (millis() - TxPosUpdMarker) > 2000)
    {
        ...
        case 2:
            ...
            56.042176, 38.483176 село Стромынь
            56.051883, 38.550843 деревня Черново
            55.950197, 38.207984 деревня Мизиново
            55.943863, 38.151805 деревня Топорково
            19 км.
            */
            if (!alien_dist)
            {
                alien_lat2 += 0.002299/2;
                alien_lon2 += 0.006880/2;

                if (alien_lat2 >= 56.051883)
                {
                    alien_lat2 = 56.051883;
                    alien_dist = true;
                }
                test_curse = 57.0;
            }
            ...
            if (alien_dist)
            {
                ...
                if (alien_lat2 <= 55.943863)
                {
                    alien_lat2 = 55.943863;
                    alien_dist = false;
                }
                test_curse = 240.0;
            }
