        ...
        case 2:
            ...
            */
            if (!alien_dist)
            {
                ...
                if (alien_lat2 >= 56.042176)
                {
                    alien_lat2 = 56.042176;
                    alien_dist = true;
                }
            }
            ...
            if (alien_dist)
            {
                ...
                if (alien_lat2 <= 55.950197)
                {
                    alien_lat2 = 55.950197;
                    alien_dist = false;
                }
            }
            ...
            {
                test_curse = test_bearing_calc(latitude_old, longitude_old, ThisAircraft.latitude, ThisAircraft.longitude);
...
float test_bearing_calc(float lat, float lon, float lat2, float lon2)
{
