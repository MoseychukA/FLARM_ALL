...
// начать чтение с первого байта (адрес 0) EEPROM
...
void EEPROM_defaults()
{
  ...
  eeprom_block.field.settings.rf_protocol   = hw_info.model == SOFTRF_MODEL_BRACELET ?
                                              ...
                                              RF_PROTOCOL_OGNTP : RF_PROTOCOL_OGNTP;
  ...
  /* Ёто ускорит Ђзаводскуюї последовательность загрузки в выпусках, отличных от Standalone. */
  ...
  eeprom_block.field.settings.block_addr = 0xC6C691;
  //eeprom_block.field.settings.block_addr[1] = 0xC;
  //eeprom_block.field.settings.block_addr[2] = 0x6;
  //eeprom_block.field.settings.block_addr[3] = 0xC;
  //eeprom_block.field.settings.block_addr[4] = 0x9;
  //eeprom_block.field.settings.block_addr[5] = 0x0;
