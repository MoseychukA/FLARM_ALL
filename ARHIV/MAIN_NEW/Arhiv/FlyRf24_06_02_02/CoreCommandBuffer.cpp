...
//!!++++++++++++++++++++++++++++++++++++++ Переделать ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
      ...
      settings->mail[count_message][2] = NumberMessage;

      for (int i = 3; i < 23; i++)
      {
          settings->mail[count_message][i] = time_msg_tmp[i];
      }
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  /*    for (int i = count_message-1; i < 100; i++)
      ...
      //for (int i = 0; i < 128; i++)
      //{
      //    uint16_t mail_tmp1 = EEPROM.read(settings->mail[1][i]);
      //    // pStream->print(EEPROM.read(settings->mail[i]),HEX);
      //   // pStream->print(mail_tmp1, HEX);
      //    // pStream->print(EEPROM.read(settings->mail[i]));
      //    pStream->print("|");
      //}
