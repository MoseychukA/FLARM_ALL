...
bool ogntp_decode(void *pkt, ufo_t *this_aircraft, ufo_t *fop) {
 ...
 /* for (u1_t i = 0; i < 20; i++)
  {
      Serial.print(fop[i], HEX);
      Serial.print("|");
  }*/


 /* Serial.print("ogn_rx_pkt.Packet.Header.Address; =");
  Serial.println(ogn_rx_pkt.Packet.Header.Address, HEX);*/
...
//  }
 ...
 /* if ( ogn_rx_pkt.Packet.Header.Other ||
  ...
  //Serial.println(fop->latitude);
  //Serial.print("fop->longitude =");
