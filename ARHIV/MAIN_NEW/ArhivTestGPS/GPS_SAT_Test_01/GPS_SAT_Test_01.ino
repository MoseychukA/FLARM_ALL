...
//Эта функция вызывается из библиотеки SparkFun Ublox Arduino.
//По мере поступления каждого символа NMEA вы можете указать, что с ним делать
//Полезно для передачи в другие библиотеки, такие как tinyGPS, MicroNMEA или даже
//буфер, радио и т.д.
