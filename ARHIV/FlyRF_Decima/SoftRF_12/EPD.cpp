...
bool EPD_setup(bool splash_screen)
{
  ...
  display->setFreeFont(&FreeMonoBold24pt7b);
  //display->print(EPD_SoftRF_text1/*, 0, 0,*//*, &tbx1, &tby1, &tbw1, &tbh1*/);
  ...
  if (hw_info.model == SOFTRF_MODEL_BADGE) {
    ...
    display->setFreeFont(&FreeMono18pt7b);
 ...
 //!! display->display(false);
  ...
  rval = DISPLAY_TFT_TTGO_240;//display->probe();
...
//      while (!SoC->Display_lock()) { delay(10); }
      ...
      {
#endif
        display->fillScreen(TFT_BLACK /* TFT_WHITE */);
...
//      while (!SoC->Display_lock()) { delay(10); }
     ...
     //!!display->getTextBounds(msg, 0, 0, &tbx, &tby, &tbw, &tbh);
      ...
      display->drawBitmap(x, y, sleep_icon_128x128, 128, 128, TFT_BLACK);
      ...
      display->setFreeFont(&FreeMonoBoldOblique9pt7b);
