...
hardware_info_t hw_info = {
  .model    = SOFTRF_MODEL_STANDALONE, //SOFTRF_MODEL_WEBTOP_SERIAL,
...
void setup()
{
  ...
  if (hw_info.model == SOFTRF_MODEL_WEBTOP_USB && settings->m.connection == CON_USB) 
  {
...
void normal_loop()
{
  ...
  Traffic_ClearExpired();  //Срок очистки трафика истек
