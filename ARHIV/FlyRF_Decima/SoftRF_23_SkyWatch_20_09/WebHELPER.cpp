...
<input type='radio' name='no_track' value='1' %s>On\
  ...
  snprintf_P(offset, size,
      PSTR("\
<tr>\
<th align=left>Alarm&nbsp;warning(200-2000m)</th>\
<td align=right>\
...
settings->alarm_warning);
  ...
  snprintf_P(offset, size,
      PSTR("\
<tr>\
<th align=left>Alarm&nbsp;danger(20-200m)</th>\
<td align=right>\
<INPUT type='number' name='danger' min='20' max='200' value='%d'>\
</td>\
</tr>"),
settings->alarm_danger);
 ...
 snprintf_P(offset, size,
      PSTR("\
<tr>\
<th align=left>Alarm&nbsp;height(30-300m)</th>\
<td align=right>\
...
<body>\
 <table width=100%%>\
  ...
  <td align=center><h1>FlyRF проба</h1></td>\
...
<tr><th align=left>Alarm.warning</th><td align=right>%d</td></tr>\
<tr><th align=left>Alarm.danger</th><td align=right>%d</td></tr>\
<tr><th align=left>Alarm.height</th><td align=right>%d</td></tr>\
...
<hr>\
  ...
  settings->power_save, settings->alarm_warning, settings->alarm_danger,
  settings->alarm_height, settings->freq_corr,
  settings->igc_key[0], settings->igc_key[1], settings->igc_key[2], settings->igc_key[3]
  );
  SoC->swSer_enableRx(false);
