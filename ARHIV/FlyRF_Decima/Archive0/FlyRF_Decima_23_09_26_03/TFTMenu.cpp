...
TFT_eSprite Back_Airplane = TFT_eSprite(&tft);

TFT_eSprite Compass = TFT_eSprite(&tft);
TFT_eSprite BackCompass = TFT_eSprite(&tft);
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 /*
    tft.setPivot(60, 120);
    Airplane.createSprite(32, 32);
    Back_Airplane.createSprite(40, 40);
    Airplane.pushImage(0, 0, 32, 32, Airplane1);

   
    Compass.createSprite(240, 240);
    BackCompass.createSprite(320, 240);*/
   // Compass.pushImage(0, 0, 240, 240, kompas);
 ...
 /*      drawVoltage(menuManager);
  ...
  // Back_Airplane.fillSprite(TFT_BLACK);
  //// Airplane.pushRotated(&Back_Airplane, angle, TFT_BLACK);
  // Airplane.pushSprite(144, 104);          // Выводим 
  //// Back_Airplane.pushSprite(140, 100);       // Выводим задний фон
  //// Airplane.pushSprite(144, 104);          // Выводим 

  // BackCompass.fillSprite(TFT_BLACK);
  // //Compass.pushRotated(&BackCompass, angle, TFT_BLACK);
  // //BackCompass.pushSprite(0, 0);       // Выводим задний фон
  // 
  // Compass.drawCircle(140, 100, 115, TFT_WHITE);
  // Compass.pushRotated(&BackCompass, angle, TFT_BLACK);
  // BackCompass.pushSprite(0, 0);


  // back.fillSprite(TFT_BLACK);
  // back.drawCircle(120,120, 100, TFT_SILVER);
  //// back.fillCircle(85, 85, 85, TFT_SILVER);
  // needle.fillSprite(TFT_RED);
  // needle.drawWedgeLine(10, 0, 10, 40, 1, 10, TFT_GREEN);
