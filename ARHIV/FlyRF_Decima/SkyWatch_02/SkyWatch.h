...
/*
 * Если вам необходимо, чтобы SkyWatch работал в беспроводном режиме
  ...
  *
  * Если встроенная точка доступа SkyWatch недостаточно стабильна для вас, рассмотрите возможность
  * использовать «обратный» режим, когда ваш смартфон действует
  * в качестве точки доступа для устройства SkyWatch в качестве клиента:
  *
...
#define MY_ACCESSPOINT_SSID "ASUS"
#define MY_ACCESSPOINT_PSK  "panasonic"
