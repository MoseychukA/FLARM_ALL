...
//--------------------------------------------------------------------------------------------------------------------------------
TFTModuleClass TFTModuleMain;
//--------------------------------------------------------------------------------------------------------------------------------
TFTModuleClass::TFTModuleClass()
{
...
void TFTModuleClass::build_banner(String msg, int xpos)
{
    int h = IHEIGHT;
...
// #########################################################################
void TFTModuleClass::numberBox(int num, int x, int y)
{
...
// #########################################################################
unsigned int TFTModuleClass::rainbow(byte value)
{
