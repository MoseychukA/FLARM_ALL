...
static void ESP32_post_init()
{
  ...
  {
    case D1090_UART_MINI:  Serial.println(F("D1090_UART_MINI"));      break;
    case D1090_UART_FULL:  Serial.println(F("D1090_UART_FULL"));      break;
    case D1090_OFF       :
    default              :  Serial.println(F("NULL"));      break;
  }
...
static bool ESP32_Baro_setup()
{
  ...
  //} 
  //else if (esp32_board == ESP32_S3_DEVKIT || esp32_board == ESP32_TTGO_T_BEAM_SUPREME) 
  //{
...
static void ESP32_Button_setup()
{
 // int button_pin = SOC_GPIO_PIN_TBEAM_V05_BUTTON;
  int button_pin = SOC_GPIO_PIN_TBEAM_V08_BUTTON;
...
//  }
// else 
    if ((hw_info.model == SOFTRF_MODEL_PRIME_MK2 && hw_info.revision >= 8) ||  esp32_board == ESP32_TTGO_T_BEAM_SUPREME) 
    {
        //button_pin = (esp32_board == ESP32_TTGO_T_BEAM_SUPREME) ?
        //                SOC_GPIO_PIN_S3_BUTTON :
        //                SOC_GPIO_PIN_TBEAM_V08_BUTTON;
        button_pin = SOC_GPIO_PIN_TBEAM_V08_BUTTON;
