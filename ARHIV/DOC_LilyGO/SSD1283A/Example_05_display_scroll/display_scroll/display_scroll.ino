...
void show_chinese_test(void)
{
    uint16_t i;
     ...
     show_chinese(0, 10,RED,BLACK,(uint8_t *)"欢迎您",16,1);
     show_chinese(0, 26,GREEN,BLACK,(uint8_t *)"欢迎您",24,1);
     show_chinese(0, 50,BLUE,BLACK,(uint8_t *)"欢迎您",32,1);
     ...
     show_chinese(0, 10,RED,WHITE,(uint8_t *)"欢迎您",16,0);
     show_chinese(0, 26,GREEN,WHITE,(uint8_t *)"欢迎您",24,0);
     show_chinese(0, 50,BLUE,WHITE,(uint8_t *)"欢迎您",32,0);
}
...
void show_pic(void)
{
    ...
    my_lcd.Push_Any_Color((uint8_t*)penguin_pic, 1600, 1, 1);
 }
