...
{
    DISPLAY_NONE,
    DISPLAY_OLED_HELTEC,   /* 0.96", 128X64, SSD1306 */
};
...
//#endif
//
//#define SOC_GPIO_PIN_STATUS   (hw_info.model != FLYRF_MODEL_PRIME_MK2 ?\
//                                SOC_UNUSED_PIN :                        \
//                                (hw_info.revision == 2 ?                \
...
//                                      SOC_UNUSED_PIN))))
//
//#define SOC_GPIO_PIN_GNSS_PPS (hw_info.model == FLYRF_MODEL_PRIME_MK3 ?  \
...
//                                  SOC_UNUSED_PIN)))
//
//#define SOC_GPIO_PIN_BUZZER   (hw_info.model == FLYRF_MODEL_PRIME_MK2 ? \
//                                SOC_UNUSED_PIN :                         \
...
#define HELTEC_OLED_PIN_SDA             9
#define HELTEC_OLED_PIN_SCL             8
