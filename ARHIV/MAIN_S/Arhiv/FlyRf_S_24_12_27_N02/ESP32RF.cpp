...
static void ESP32_Display_loop()
{
    ...
    { /* TFT_display_frontpage  Основная программа отображения воздушной обстановки*/ 
        ...
        if (new_buttton == 1)
        {
           //  new_buttton = service.get_num_buttton();
             count_buttton_tmp++;

        }
        if (new_buttton != 0 && new_buttton > 1)
        {
            count_buttton_tmp = 300;
        }
        ...
        if (new_buttton != 0 && count_buttton_tmp == 300)
        {
            Serial.print("Button pressed down: ");
            Serial.println(new_buttton);
            Serial.print("count_buttton_tmp: ");
            Serial.println(count_buttton_tmp);
            count_buttton_tmp = 0;
            switch (new_buttton) 
            {
            case 1:
