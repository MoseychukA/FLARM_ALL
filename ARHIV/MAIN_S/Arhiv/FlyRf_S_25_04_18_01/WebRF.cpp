...
<tr>\
<th align=left>latitude(широта &#177;90&#176) </th>\
<td align=right>\
<INPUT type='number' name='test_latitude' placeholder='1.0' step='0,000001' min='-90' max='90' value='%d'>\
</td>\
</tr>\
<tr>\
<th align=left>longitude(долгота &#177;180&#176) </th>\
<td align=right>\
<INPUT type='number' name='test_longitude' placeholder='1.0' step='0,000001' min='-180' max='180' value='%d'>\
</td>\
</tr>\
"),
settings->freq_corr,
...
settings->test_latitude, settings->test_longitude
);
...
/*
<th align=left>latitude(широта &#177;90,000000&#176) </th>\
<td align=right>\
<INPUT type='number' name='latitude' placeholder='1.0' step='0,000001' min='-90,000000' max='90,000000' value='%06d'>\
</td>\
</tr>\
<tr>\
<th align=left>longitude(долгота &#177;180,000000&#176 </th>\
<td align=right>\
<INPUT type='number' name='longitude'  placeholder='1.0' step='0,000001' min='-180,000000' max='180,000000' value='%06d'>\
 ...
 <table width=100%%>\
  <tr>\
    ...
    <td align=center><input type=button onClick=\"location.href='/about'\" value='Информация'></td>"),
        ...
        gnss.time.hour(), gnss.time.minute(), gnss.time.second(), sats, str_lat, str_lon, str_alt
    );
...
void hardwareInput() 
{
    ...
    //char str_lat[16];
    //char str_lon[16];
    //dtostrf(settings->test_latitude, 8, 6, str_lat);
    //dtostrf(settings->test_longitude, 8, 6, str_lon);
