...
float alien_lat1 = 56.026725;
float alien_lon1 = 38.291524;
...
55.993891, 38.339010  городской округ Черноголовка
   */
    ...
    int set_air = 3;   // Варианты движения самолетов
    ...
    case 0:
        ...
        break;
    case 1:
        ThisAircraft.latitude = 55.950197 + (0.004598 * 10);
        ThisAircraft.longitude = 38.207984 + (0.013759 * 10);
        altitude1 = 100;
        break;
    case 2:
        ...
        */
        if (!alien_dist)
        {
            alien_lat += 0.004598 / 4;
            alien_lon += 0.013759 / 4;
