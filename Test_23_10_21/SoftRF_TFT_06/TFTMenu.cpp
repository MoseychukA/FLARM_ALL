...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 void TFTMenuScreen::update(TFTMenu* menuManager)
 {
   ...
   angle = 360 - 345;// test_curse;                     // Определяем направление нашего самолета и вращаем в другую сторону шкару
 ...
 /*          Serial.print(" lat ");
          ...
          /* if (distance < LED_DISTANCE_FAR)
           ...
           Container[i].alien_Y = new_y;
            ...
            Air_txt_Sprite[i]->setTextColor(little_air_color, TFT_BLACK);
          ...
          //  Air_txt_Sprite[i]->drawString(String(int(altitude)), 12, 25, 1);
            ...
            case 1:
                ...
                Air_txt_Sprite[i]->drawString(String(int(i)), 10, 25, 1);
                Air_txt_Sprite[i]->drawString(String(int(altitude)), 20, 25, 1);
                break;
            case 2:
  ...
  /*          Serial.print("alien_curse ");
            ...
            little_airplane[i]->pushRotated(Air_txt_Sprite[i], alien_curse, TFT_BLACK);
