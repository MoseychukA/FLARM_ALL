...
{ 
	word	dsx[] = {239, 239, 239, 239, 239, 239, 175, 175, 239, 127, 127, 239, 271, 479, 239, 239, 239, 0, 0, 239, 479, 319, 239, 175, 127, 239, 239, 319, 319, 799, 127, 127, 479, 479};
	word	dsy[] = {319, 399, 319, 319, 319, 319, 219, 219, 399, 159, 127, 319, 479, 799, 319, 319, 319, 0, 0, 319, 799, 479, 319, 219, 159, 319, 319, 479, 479, 479, 159, 159, 799, 799};
	byte	dtm[] = {16, 16, 16, 8, 8, 16, 8, SERIAL_4PIN, 16, SERIAL_5PIN, SERIAL_5PIN, 16, 16, 16, 8, 16, LATCHED_16, 0, 0, 8, 16, 16, 16, 8, SERIAL_5PIN, SERIAL_5PIN, SERIAL_4PIN, 16, 16, 16, SERIAL_5PIN, SERIAL_5PIN, 16, 16};
...
void UTFT::writeCommand16Transaction(uint16_t c)
{
  digitalWrite(__p3, LOW);
  digitalWrite(__p1, LOW);
  writeData16(c);
  digitalWrite(__p1, HIGH);
  digitalWrite(__p3, HIGH);
}


void UTFT::writeCommand16(uint16_t c)
{
  digitalWrite(__p1, LOW);
  writeData16(c);
  digitalWrite(__p1, HIGH);
...
void UTFT::writeData16Transaction(uint16_t d, uint32_t num)
{
  digitalWrite(__p3, LOW);
  writeData16(d, num);
  digitalWrite(__p3, HIGH);
...
void UTFT::writeData16(uint16_t d, uint32_t num)
{
...
#endif
#ifndef DISABLE_OTM8009A
	#include "tft_drivers/otm8009a/initlcd.h"
#endif
...
#endif
#ifndef DISABLE_OTM8009A
	#include "tft_drivers/otm8009a/setxy.h"
#endif
#ifndef DISABLE_NT35510
