...
void EEPROM_defaults()
{
  ...
  eeprom_block.field.settings.local_latitude   = 55.93574;
  eeprom_block.field.settings.local_longitude  = 37.34873;
  eeprom_block.field.settings.input_E_W = IMPUT_E;
  eeprom_block.field.settings.input_N_S = IMPUT_N;
  eeprom_block.field.settings.view_test_coord = VIEW_COORD_OFF;
  ...
  eeprom_block.field.settings.g_localIP[3] = 247;
  ...
  eeprom_block.field.settings.g_dns_server[3] = 0;
}
