...
static String settingsPage()
{
    ...
    html += F("<div class='settingsBlock'><div class='blockTitle'>&#1054;&#1073;&#1097;&#1080;&#1077; &#1088;&#1077;&#1078;&#1080;&#1084;&#1099;</div><table>");
    html += F("<tr><th>TRACKER send</th><td><select class='wShort settingsTopCtl50' name='tracker_send'>");
    html += String("<option ") + sel(settings && settings->tracker_send == 0) + " value='0'>Off</option>";
    html += String("<option ") + sel(settings && settings->tracker_send == 1) + " value='1'>Single</option>";
    html += String("<option ") + sel(settings && settings->tracker_send == 2) + " value='2'>Auto</option>";
    html += String("<option ") + sel(settings && settings->tracker_send == 3) + " value='3'>Mini</option>";
    html += F("</select></td></tr>");    html += F("<tr><th>NMEA output</th><td><select class='wMed settingsTopCtl50' name='nmea_out'>");
    html += String("<option ") + sel(settings && settings->nmea_out == 0) + " value='0'>Off</option>";
    html += String("<option ") + sel(settings && settings->nmea_out == NMEA_OUT_UDP) + " value='1'>UDP</option>";
    html += F("</select></td></tr>");
    html += F("</table></div>");
...
static String outputsPage()
{
    ...
    html += F("</select></td></tr>");    html += F("<tr><th>&#1042;&#1099;&#1074;&#1086;&#1076; &#1076;&#1072;&#1085;&#1085;&#1099;&#1093; &#1074; Serial</th><td><select class='wMed hardwareCtl50' name='serial_out'>");
    html += String("<option ") + sel((settings ? settings->serial_out : OUTPUT_MODE_OFF) == OUTPUT_MODE_OFF) + " value='0'>&#1053;&#1077; &#1074;&#1099;&#1074;&#1086;&#1076;&#1080;&#1090;&#1100;</option>";
