...
void handleRoot() // Отображение основных настроек
{
  ...
  <td align=left><table><tr><th align=left>Radio&nbsp;&nbsp;</th><td align=right>%s</td></tr></table></td>\
  </table><table width=100%%>"
  "</table>\
  <table width=100%%>\
  ...
  <tr><th align=left>Gateway</th><td align=right>%d.%d.%d.%d</td></tr>\
...
static bool parseIP(const String& src, uint8_t out[4])
{
    int a, b, c, d;
