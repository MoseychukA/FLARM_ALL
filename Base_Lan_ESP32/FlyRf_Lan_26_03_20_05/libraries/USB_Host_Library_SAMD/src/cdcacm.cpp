...
uint32_t ACM::Init(uint32_t parent, uint32_t port, uint32_t lowspeed) {
...
void ACM::EndpointXtract(uint32_t conf, uint32_t iface __attribute__((unused)), uint32_t alt __attribute__((unused)), uint32_t proto __attribute__((unused)), const USB_ENDPOINT_DESCRIPTOR *pep) {
