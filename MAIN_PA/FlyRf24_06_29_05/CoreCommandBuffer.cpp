...
bool CommandHandlerClass::setFly(const char* param)
{
 ...
 //    Serial.println(flight);
   ...
   // Serial.println(aircraft_type);
    ...
    Traffic_Add(&fo);
   //#4#SET#FLY#3BC7C9,1234,SMD6406,100.0,810.0,20.0,50,56.033575,37.289899,2 // Пример строки
   //#4#SET#FLY#3BC7C9,1234,SMD6406,100.0,810.0,20.0,50,55.933575,37.589899,2
   //#4#SET#FLY#3BC7C9,1234,SMD6406,100.0,210.0,20.0,50,55.933575,37.189899,2
