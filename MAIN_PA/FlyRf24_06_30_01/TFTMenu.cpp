                ...
                if (Container[i].addr)  // Если есть данные стороннего самолета
                {
                 ...
                 //================================== Фильтр высоты стороннего самолета =============================================
                    ...
                    */
                    ...
                    if (set_table_alien[i].lat == 0 && set_table_alien[i].lon == 0 && set_table_alien[i].altitude != 0 && set_table_alien[i].signal_source == 1 && set_table_alien[i].signal_source != 2 && set_table_alien[i].signal_source != 3)
                    {
