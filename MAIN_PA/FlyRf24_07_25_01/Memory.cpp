...
void MemInit()
{
   // uint8_t  mail[Max_Count_Block_Message][128];             // ������ ��� ��������� �����
...
void MemClear()
{
 ...
 //   dc->setEntryMode();
 //   dc->powerMode(SSD1311_LCD_ON);
 //   MemWrite(0, MEM_CONTROL_BYTE);                              // ������ ������������ ����, ����������� ������������� ������
 //   MemWrite(All_Count_Text_Message_ADDRESS, 0);                // ����� �������� �������� ������ ���������� �������
 //   MemWrite(Count_NotRead_Message_ADDRESS, 0);                 // ����� �������� �������� �� ������������ ���������� �������
 //   MemWrite(Current_Counter_Message, 0);                       // ����� �������� �������� �������� ���������� �������
 //   MemWrite(Flipping_Counter_Message, 0);                      // ����� �������� �������� �������� �������
 //  // MemWrite(TmpCount_Flip_Message_ADDRESS, 0);                 // ����� �������� ���������� �������� ���������� �������
 //   MemWrite(Response_message_block_ADDRESS, 0);                // ��������� ����� �������� �������� �������� ���������
 //   MemWrite(Current_Counter_confirmation, 0);                  // �������� ����� ����� ������������ �������������.
 //   dc->setCursor(0, 3);                                        // ���������� ������ � ������ ������
 //   dc->print("End..");                                       // ���������� ����� ���������
