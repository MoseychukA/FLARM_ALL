        ...
        if ((Container[i].addr && (this_moment - Container[i].timestamp) <= EXPORT_EXPIRATION_TIME)/* || Container[i].signal_source == 2*/)
        {
          ...
          if (settings->nmea_l) 
          {
            ...
            if (distance < ALARM_ZONE_NONE) 
            {
              ...
              memset(&NMEABuffer, 0, sizeof(NMEABuffer));  // �������� ����� ��� ������ $FLYRF
              delay(10);
              snprintf_P(NMEABuffer, sizeof(NMEABuffer),
                  ...
                  Container[i].Squawk,                 // �����, ����������� ����������� ��� ������ � ���������.
                  Container[i].flight,                 // ����� �����
                  (int)Container[i].altitude,          // ������ ����� (GPS)
                  (int)Container[i].pressure_altitude, // ������ �� ������� ��������
                  (int)(Container[i].speed /** _GPS_MPS_PER_KNOT*/), // ��������  km/h IAS
                  (int)Container[i].course,            // ���� � ��������
                  Container[i].vert_rate,              // �������� ������� ��� �������� ft/m
                  Container[i].latitude,               // ������
                  Container[i].longitude,              // �������
                  Container[i].aircraft_type,          // ��� ���������� �����
                  Container[i].signal_source,          // �������� ������ (0-LoRa, 1- DUMP1090, 2 - ��������� ������ �� GSM ��� �������)
                  Container[i].hour_msg,               // ����� (����) �� ��������� 2
                  Container[i].min_msg                 // ����� (������) �� ��������� 2 
                  FLYRF_EXT1_ARGS);
