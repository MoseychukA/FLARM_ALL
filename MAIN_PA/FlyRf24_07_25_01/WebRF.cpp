...
(settings->mode == SOFTRF_MODE_TXRX_TEST4 ? "selected" : ""), SOFTRF_MODE_TXRX_TEST4,
(settings->mode == SOFTRF_MODE_TXRX_TEST5 ? "selected" : ""), SOFTRF_MODE_TXRX_TEST5,
...
<body>\
 <table width=100%%>\
  ...
  <td align=center><h1>FlyRF ������</h1></td>\
  <!-- <td align=right><img src='/logo.png'></td> --></tr>\
 </table>\
 <table width=100%%>\
  <tr><th align=left>������������� ����������</th><td align=right>%06X</td></tr>\
  <tr><th align=left>����������� �����</th><td align=right>%06X</td></tr>\
  <tr><th align=left>������ ��</th><td align=right>%s</td></tr>"
...
#endif /* ENABLE_AHRS */
  "<tr><th align=left>����� ������</th><td align=right>%02d:%02d:%02d</td></tr>\
  <tr><th align=left>��������� ������</th><td align=right>%u</td></tr>\
  <tr><th align=left>���������� �������</th><td align=right><font color=%s>%s</font></td></tr>"
 ...
 <h2 align=center>��������� ������ GNSS</h2>\
 <table width=100%%>\
  <tr><th align=left>�����</th><td align=right>%u</td></tr>\
  <tr><th align=left>���������</th><td align=right>%d</td></tr>\
  <tr><th align=left>Latitude</th><td align=right>%s</td></tr>\
  <tr><th align=left>Longitude</th><td align=right>%s</td></tr>\
  <tr><td align=left><b>������ ��� ������� ����</b></td><td align=right>%s</td></tr>\
 </table>\
 <hr>\
 <table width=100%%>\
  <tr>\
    <td align=left><input type=button onClick=\"location.href='/settings'\" value='���������'></td>\
    <td align=center><input type=button onClick=\"location.href='/about'\" value='����������'></td>"),
    ThisAircraft.addr, settings->block_addr, str_ver/*FLYRF_FIRMWARE_VERSION*/
#if defined(USE_USB_HOST)
    "H"
#endif /* USE_USB_HOST */
 ...
 /* if (SoC->id != SOC_RP2040) {*/
    ...
    <td align=right><input type=button onClick=\"location.href='/firmware'\" value='���������� ���������'></td>"));
    len = strlen(offset);
    offset += len;
    size -= len;
  //}
...
<tr><th align=left>Rssi view</th><td align=right>%d</td></tr>\
