...
typedef struct
{
    ...
    uint8_t altitude_type;                   // Вариант измерения высоты. 0 - не определен, 1 - геоид, 2 - барометр, 3 - dump1090
...
private:
    ...
    bool flashing_on_off;  //Режим включени или потушен
	bool power_supple;
