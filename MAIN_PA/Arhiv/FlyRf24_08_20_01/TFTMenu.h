...
public:
    ...
    void onButtonisRetention(TFTMenu* menuManager, int buttonID);
    void onButtonisDoubleClicked(TFTMenu* menuManager, int buttonID);
...
private:
    ...
    //void still_image(TFTMenu* menuManager, int angle, int divider_num);
    ...
    int pressed_button_DoubleClicked;
 ...
 /*   String Current_version;*/
   ...
   // table_alien set_table_alien[MAX_TRACKING_OBJECTS];
    ...
    //bool button_Retention_on = false;
...
public:
  ...
  void onButtonisDoubleClicked(int button);
