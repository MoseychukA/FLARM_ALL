...
#define TFT_EXPIRATION_TIME     10 /* seconds */
...
public:
    ...
    bool setMailRead  =    false;

 
private:
    void drawMessage(TFTMenu* menuManager, int count_message, int count_view);
    ...
    void clearMail(TFTMenu* menuManager);
    ...
    //uint8_t this_speed_array_count = 0;          // Размер массива фильтра скорости самолета
    //uint8_t this_course_array_count = 0;         // Размер массива фильтра курса самолета
    //bool this_course_array_countMax = false;
    //int this_course_sum = 0;
    ...
    uint8_t array_size_course = 20;
    int dimension_array_course[20];


    ///* Переменные для фильтра скорости нашего самолета*/
    //float RunningAverageSpeedBuffer[16];
    //int NextRunningAverageSpeed;

    ///* Переменные для фильтра курса нашего самолета*/
    //float RunningAverageCourseBuffer[16];
    //int NextRunningAverageCourse;

    ///* Переменные для фильтра высоты нашего самолета*/
    //float RunningAverageAltitudeBuffer[16];
    //int NextRunningAverageAltitude;
