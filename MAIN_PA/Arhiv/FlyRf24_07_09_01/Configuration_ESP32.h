...
#define DATA_FLASHING_ON               2600    // через сколько миллисекунд подсвечивать сообщение
#define DATA_FLASHING_OFF               500    // через сколько миллисекунд не подсвечивать сообщение
...
#define SEND_POINT_TIME_ON               3000          // время 3 сек. 
...
#define MAIL_OFF_DELAY        60000ul     // время выключения подсветки сообщения при бездействии, миллисекунд
...
#define Max_Count_Block_Message            5    // Максимальное количество блоков записей сообщений
