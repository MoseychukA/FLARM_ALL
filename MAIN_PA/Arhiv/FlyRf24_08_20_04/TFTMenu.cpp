     ...
     if (millis() - tmr > DATA_MEASURE_THRESHOLD)
     {
         ...
         else
         {
            ...
            /* =========== Фильтр скорости нашего самолета. ================== */
             ...
             thisAircraft_speed_tmr = (int)RunningAverageSpeed;                 // Данные по скорости нашего самолета после фильтра
             ...
             angle = (360 - (int)RunningAverageCourse) % 360;                   // Данные по курсу нашего самолета после фильтра
