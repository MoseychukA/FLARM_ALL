...
const char *LPC43_Device_Manufacturer = FLYRF_IDENT;
const char *LPC43_Device_Model        = "ES Edition";
const uint16_t LPC43_Device_Version   = FLYRF_USB_FW_VERSION;

const char *LPC43_boot_str1 = FLYRF_IDENT "-" PLAT_LPC43_NAME
                              " FW.REV: " FLYRF_FIRMWARE_VERSION " DEV.ID: ";
...
#if FLYRF_USB_FW_VERSION > 0x0101 /* not active until release */
