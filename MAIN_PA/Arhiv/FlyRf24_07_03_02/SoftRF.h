...
#define FLYRF_FIRMWARE_VERSION "FlyRf_24_06_29_01"
...
typedef struct UFO {
    ...
    float     latitude;
    float     longitude;
    float     altitude;          // Вариант измерения высоты. геоид
    float     pressure_altitude; // Вариант измерения высоты. барометр, dump1090
    float     course;     /* CoG */
...
enum
{
	...
	SOFTRF_MODE_BRIDGE,
	SOFTRF_MODE_RELAY,
	SOFTRF_MODE_TXRX_TEST1,
	SOFTRF_MODE_TXRX_TEST2,
	SOFTRF_MODE_TXRX_TEST3,
	SOFTRF_MODE_TXRX_TEST4,
	SOFTRF_MODE_TXRX_TEST5,
