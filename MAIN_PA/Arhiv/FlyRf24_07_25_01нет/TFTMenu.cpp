     ...
     if (millis() - tmr > DATA_MEASURE_THRESHOLD)
     {
         ...
         else
         {
            ...
            // time_info.
             ...
             /*Serial.println(rssi_vol);*/

             //if (rssi_vol < 0)
             //{
             //    rssi_txt = String(rssi_vol);
             //    rssi_info.drawString(rssi_txt + " db", 40, 4);
             //}
             //else
             //{
             //    rssi_info.drawString("-----", 40, 4);
             //}
