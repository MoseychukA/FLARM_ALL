...
bool CommandHandlerClass::setFly(const char* param)
{
 ...
 //    Serial.println(flight);
   ...
   //#4#SET#FLY#3BC7C7,1234,SMD6406,250,100.0,810.0,20.0,50,55.933575,37.589899,2
   //#4#SET#FLY#3BC7C1,1234,SMD6406,340,100.0,210.0,20.0,50,55.833575,37.189899,2
