...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 void TFTMenuScreen::setup(TFTMenu* menuManager)
 {
   ...
   for (int i = 0; i < MAX_TRACKING_OBJECTS; i++)
   {
       ...
       Air_txt_Sprite[i]->createSprite(100, 15);
       Air_txt_Sprite[i]->setPivot(50, 7);
                         ...
                         */
                         ...
                         if (set_table_alien[i].lat != 0.0 && set_table_alien[i].lon != 0.0)
                         {
                             ...
                             if (height_difference[i] >= 0) // Чужой самолет выше нашего
                             {
                                 ...
                                 {
                                     Air_txt_Sprite[i]->drawString("+" + String(int(height_difference[i]))+"/"+ Container[i].hour_msg + ":"+ Container[i].min_msg, 50, 1, 0);
                                 }
                                 else
                                 {
                                     Air_txt_Sprite[i]->drawString("+" + String(int(height_difference[i])), 50, 1, 0);
                                 }
                             }
                             else
                             {
