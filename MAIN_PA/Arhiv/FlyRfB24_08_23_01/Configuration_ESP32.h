...
#define DUMP_FLASHING_OFF              2500    // через сколько миллисекунд не подсвечивать сообщение DUMP1090
...
#define data_txt2 "СООБЩЕНИЯ УДАЛЕНЫ"
...
#define BUTTON_OFF_DELAY      600000ul     // время выключения ручного диапазона просмотра
...
#define Max_Count_Block_Message            3    // Максимальное количество блоков записей сообщений
...
#define Number_of_bytes_msg               96    // кличество байт одного блока переданных текстовых сообщений данных о чужом самолете
