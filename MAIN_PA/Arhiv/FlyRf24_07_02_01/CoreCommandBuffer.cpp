...
bool CommandHandlerClass::setFly(const char* param)
{
 ...
 //    Serial.println(flight);
    ...
    param = delim + 1;               // Вариант измерения высоты. 0 - не определен, 1 - геоид, 2 - барометр, 3 - dump1090
    delim = strchr(param, ',');
    ...
    *writePtr = 0;
    ...
    altitude_type = atof(writePtr);
    // Serial.println(altitude_type);
   ...
   // Serial.println(aircraft_type);
    ...
    fo.altitude_type = altitude_type;
