...
void NMEA_Export()
{
    ...
    bool has_Fix       = isValidFix() || (settings->mode == SOFTRF_MODE_TXRX_TEST1) || (settings->mode == SOFTRF_MODE_TXRX_TEST2) || (settings->mode == SOFTRF_MODE_TXRX_TEST3) || (settings->mode == SOFTRF_MODE_TXRX_TEST4);
...
void NMEA_Position()
{
  ...
  if (settings->nmea_g) {
    ...
    if ((settings->mode == SOFTRF_MODE_TXRX_TEST1) || (settings->mode == SOFTRF_MODE_TXRX_TEST2) || (settings->mode == SOFTRF_MODE_TXRX_TEST3) || (settings->mode == SOFTRF_MODE_TXRX_TEST4))
    {
        /*
