...
bool CommandHandlerClass::setFly(const char* param)
{
 ...
 //    Serial.println(flight);
    ...
    *writePtr = 0;
    ...
    Traffic_Add(&fo);
   // Пример строки
   //#4#SET#FLY#3BC7C9,1234,SMD6406,100,100.0,810.0,20.0,50,56.033575,37.289899,2,10,23
   //#4#SET#FLY#3BC7C7,1234,SMD6406,250,100.0,810.0,20.0,50,55.933575,37.589899,7,23,01
   //#4#SET#FLY#3BC7C1,1234,SMD6406,340,100.0,210.0,20.0,50,55.833575,37.189899,4,15,46
