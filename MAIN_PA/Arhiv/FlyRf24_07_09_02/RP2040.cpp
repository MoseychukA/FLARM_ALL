/*
 * Platform_RP2040.cpp
 * Copyright (C) 2022-2023 Linar Yusupov
 *
...
#if !defined(ARDUINO_ARCH_MBED)
bi_decl(bi_program_name(FLYTRF_IDENT));
bi_decl(bi_program_description(SOFTRF_DESC));
bi_decl(bi_program_version_string(FLYTRF_FIRMWARE_VERSION));
...
const char *RP2040_Device_Manufacturer = FLYTRF_IDENT;
const char *RP2040_Device_Model        = "Lego Edition";
const uint16_t RP2040_Device_Version   = FLYTRF_USB_FW_VERSION;
