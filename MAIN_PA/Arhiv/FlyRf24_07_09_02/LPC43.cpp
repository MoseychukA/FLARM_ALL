...
const char *LPC43_Device_Manufacturer = FLYTRF_IDENT;
const char *LPC43_Device_Model        = "ES Edition";
const uint16_t LPC43_Device_Version   = FLYTRF_USB_FW_VERSION;

const char *LPC43_boot_str1 = FLYTRF_IDENT "-" PLAT_LPC43_NAME
                              " FW.REV: " FLYTRF_FIRMWARE_VERSION " DEV.ID: ";
const char *LPC43_boot_str2 = "Copyright (C) 2015-2023 Linar Yusupov. ";
...
#if FLYTRF_USB_FW_VERSION > 0x0101 /* not active until release */
