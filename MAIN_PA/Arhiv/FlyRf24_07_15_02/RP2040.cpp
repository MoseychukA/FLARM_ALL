...
#if !defined(ARDUINO_ARCH_MBED)
bi_decl(bi_program_name(FLYRF_IDENT));
bi_decl(bi_program_description(SOFTRF_DESC));
bi_decl(bi_program_version_string(FLYRF_FIRMWARE_VERSION));
...
const char *RP2040_Device_Manufacturer = FLYRF_IDENT;
const char *RP2040_Device_Model        = "Lego Edition";
const uint16_t RP2040_Device_Version   = FLYRF_USB_FW_VERSION;
