            ...
            /* Фильтр скорости нашего самолета.    Нужно выяснить откуда этот пример взят Предполагаю, данные со смещением по массиву*/
             ...
             if (view_alien_count >= 1)
             {
                ...
                /* isAirDel = true;*/
                 ...
                 if (min_distance > 64000)
                 {
                     divider = 64000;  // 32000
                     divider_num = 1;
                 }
                 else if (min_distance <=  64000 && min_distance > 32000)
                 {
                     divider = 32000;  // 16000
                     divider_num = 2;
                 }
                 else if (min_distance <= 10100 && min_distance > 5100)
                 {
                     divider = 21500;  // 10000
                     divider_num = 3;
                 }
                      ...
                      //================================== Фильтр высоты стороннего самолета =============================================
                         ...
                         */
                         ...
                         if (Container[i].latitude != 0.0 && Container[i].longitude != 0.0)
                         {
                             ...
                             new_rel_x = constrain(distance_tmr[i] * sin(radians(new_angle[i])), -65534, 65534);
                             new_rel_y = constrain(distance_tmr[i] * cos(radians(new_angle[i])), -65534, 65534);
