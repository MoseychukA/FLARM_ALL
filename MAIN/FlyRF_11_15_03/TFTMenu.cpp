...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 void TFTMenuScreen::setup(TFTMenu* menuManager)
 {
   ...
   for (int i = 0; i < MAX_TRACKING_OBJECTS; i++)
   {
       ...
       Air_txt_Sprite[i]->createSprite(50, 28);
       Air_txt_Sprite[i]->setPivot(25, 14);
      ...
      //  data_KM.setTextDatum(TC_DATUM);
        ...
        for (int i = 0; i < MAX_TRACKING_OBJECTS; i++)
        {
            ...
            /* При малой скорости смотрим в центр экрана на наш самолет*/
                ...
                //int agle_form = new_angle;// 360 - angle;

                //Serial.print("agle_form ");
                //Serial.print(agle_form);

                //if (agle_form >= 0 && agle_form < 30)
                //{
                //    form_x = new_x + 10; //
                //    form_y = new_y + 15; //
                //}
                //else if (agle_form >= 30 && agle_form < 60)
                //{
                //    form_x = new_x + 10; //
                //    form_y = new_y + 13; //
                //}
                //else if (agle_form >= 60 && agle_form < 90)
                //{
                //    //form_x = new_x + 10; //
                //    //form_y = new_y + 30; //
                //}
                ////else if (agle_form >= 90 && agle_form < 120)
                ////{
                ////    form_x = new_x + 35; // ok
                ////    form_y = new_y + 10; //
                ////}
                ////else if (agle_form >= 120 && agle_form < 150)
                ////{
                ////    form_x = new_x + 20; //1
                ////    form_y = new_y + 25;
                ////}
                ////else if (agle_form >= 150 && agle_form < 180)
                ////{
                ////    form_x = new_x + 35; // ok
                ////    form_y = new_y + 10; 
                ////}
                ////else if (agle_form >= 180 && agle_form < 210)
                ////{
                ////    form_x = new_x - 30; //
                ////    form_y = new_y + 10; //1/
                ////}
                ////else if (agle_form >= 210 && agle_form < 240)
                ////{
                ////    form_x = new_x + 20; //1
                ////    form_y = new_y + 25;
                ////}
                ////else if (agle_form >= 240 && agle_form < 270)
                ////{
                ////    form_x = new_x - 20; //1
                ////    form_y = new_y + 25; 
                ////}
                ////else if (agle_form >= 270 && agle_form < 300)
                ////{
                ////    form_x = new_x - 20; //1
                ////    form_y = new_y + 25; 
                ////}
                ////else if (agle_form >= 300 && agle_form < 330)
                ////{
                ////    form_x = new_x - 15;  //
                ////    form_y = new_y + 30;  //
                ////}
                //else if (agle_form >= 330 && agle_form < 360)
                //{
                //    form_x = new_x - 60;  //
                //    form_y = new_y + 15;  //
                //}
...
//--------------------------------------------------------------------------
                ...
                {
                   // Air_txt_Sprite[i]->setTextDatum(TC_DATUM);                         //TR_DATUM 2 // Top right
                    ...
                    else if (new_y <= 100 && new_y > 80) //ok
                    {
                        form_x = new_x - 25; //1
                        form_y = new_y + 38;     //
                    }
                    else if (new_y <= 80 && new_y > 60) //ok
                    {
                        form_x = new_x - 25; //1
                        form_y = new_y + 38;     //
                    }
                    else if (new_y <= 60 && new_y > 40) //ok
                    {
                        form_x = new_x - 60; //1
                        form_y = new_y + 20;     //
                    }
                    else if (new_y <= 40 && new_y> -40) //ok
                    {
                        form_x = new_x - 60; //
                        form_y = new_y  +13;     //
                    }
                    else if (new_y <= -40 && new_y > -64)   // ok
                    {
                        form_x = new_x - 60; //
                        form_y = new_y + 15; //1
                    }
                ...
                {
                   // Air_txt_Sprite[i]->setTextDatum(TR_DATUM);                         //TL_DATUM 0 // Top left (default)
        ...
        for (int i = 0; i < MAX_TRACKING_OBJECTS; i++)
        {
            if (isTeam_all[i] == true)
            {
              ...
              // Air_txt_Sprite[i]->drawRect(0, 0, 50, 26, TFT_WHITE);
               ...
               Air_txt_Sprite[i]->drawSmoothRoundRect(0, 0,6,6, 49, 27, TFT_SKYBLUE/*TFT_WHITE*/);
