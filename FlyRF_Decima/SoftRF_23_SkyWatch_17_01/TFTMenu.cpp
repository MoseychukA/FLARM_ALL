...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 void TFTMenuScreen::update(TFTMenu* menuManager)
 {
  ...
  // needle.drawRect(0, 0, 60, 35, TFT_RED);
   ...
   data_az.pushRotated(&back, 0, TFT_BLACK);
       ...
       /*            backsprite.fillTriangle(radar_center_x + x - 4, radar_center_y - y - 3,
           ...
           //{
             ...
             /*  Serial.print("new_angle ");
               ...
               //Serial.print("new_rel_x ");
               //Serial.print(new_rel_x);

               //Serial.print(" | new_rel_y ");
               //Serial.println(new_rel_y);
               ...
               //Serial.print("radar_center_x + new_x ");
               //Serial.print(radar_center_x + new_x);

               //Serial.print(" | radar_center_y - new_y ");
               //Serial.println(radar_center_y - new_y);
              ...
              // needle.setPivot(radar_center_x + new_x, radar_center_y - new_y);
               ...
               needle.loadFont(NotoSansBold15);
               needle.setTextColor(TFT_YELLOW, TFT_BLACK);
               needle.drawRect(radar_center_x + new_x-5, radar_center_y - new_y+5, 50, 30, TFT_RED);

               needle.drawString(String(int(altitude)),radar_center_x + new_x-5+3, radar_center_y - new_y+5+3, 1);
              // needle.drawRect(needleX, needleY, 50, 30, TFT_RED);
              // needle.pushRotated(&back, (angle - (angle*2)/2), TFT_BLACK);
               needle.pushRotated(&back, 0, TFT_BLACK);
          // }
       }
   }
