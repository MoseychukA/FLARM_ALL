...
void txrx_test()
{
  ...
  //  56.009849, 38.378248  Черноголовка
  //  56.002017, 38.134184 Щёлково
    //56.023279, 38.351918

        /*17км*/

    //ThisAircraft.latitude = 56.009000 + chorno;
    //ThisAircraft.longitude = 38.378248;
    //chorno += 0.000500;
    //if (chorno == 0.014800)
    //{
    //    chorno = 0;
    //    ThisAircraft.latitude = 56.009000;
    //}
