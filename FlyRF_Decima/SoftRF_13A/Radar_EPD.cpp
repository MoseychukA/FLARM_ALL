...
//  if (SoC->Display_lock()) 
...
#else
  {
    ...
    for (int i=0; i < MAX_TRACKING_OBJECTS; i++) 
    {
        ...
        /* little airplane */
        display->drawFastVLine(radar_center_x,      radar_center_y - 4, 14, TFT_BLACK);
        display->drawFastVLine(radar_center_x + 1,  radar_center_y - 4, 14, TFT_BLACK);

        display->drawFastHLine(radar_center_x - 8,  radar_center_y,     18, TFT_BLACK);
        display->drawFastHLine(radar_center_x - 10, radar_center_y + 1, 22, TFT_BLACK);

        display->drawFastHLine(radar_center_x - 3,  radar_center_y + 8,  8, TFT_BLACK);
        display->drawFastHLine(radar_center_x - 2,  radar_center_y + 9,  6, TFT_BLACK);
        ...
        display->setFreeFont(&FreeMonoBold12pt7b);
