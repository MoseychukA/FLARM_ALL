...
//  else 
  ...
  if (hw_info.model == SOFTRF_MODEL_PRIME_MK2 || hw_info.model == SOFTRF_MODEL_PRIME_MK3) 
  {
...
static byte ESP32_Display_setup()
{
  ...
  if (esp32_board != ESP32_TTGO_T_WATCH && esp32_board != ESP32_S2_T8_V1_1/*   && esp32_board != ESP32_HELTEC_TRACKER*/) 
  {
  ...
  else
  {
    ...
    //int bl_pin = (esp32_board == ESP32_S2_T8_V1_1) ? SOC_GPIO_PIN_T8_S2_TFT_BL : (esp32_board == ESP32_HELTEC_TRACKER && hw_info.revision == 3) ?
