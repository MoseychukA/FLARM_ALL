...
// версия ПО
//--------------------------------------------------------------------------------------------------------------------------------
#define SOFTWARE_VERSION "ver.2023.09.18WEB01"  
...
#define CAL_209_CAPTION "КАЛИБРОВКА 20.9%"
...
#define PASS_CAPTION "СМЕНА ПАРОЛЯ"
#define PASS_SERVISE "ПАРОЛЬ МЕНЮ СЕРВИС"
#define PASS_TIME "ПАРОЛЬ МЕНЮ ВРЕМЯ"

#define ENTER_CAPTION "ВВОД"
#define SET_ATM_0 "ВВОД <0> ТЕСТ"
