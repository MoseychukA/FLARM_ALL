...
SSD1306Wire  display(0x3c, 500000, SDA, SCL, GEOMETRY_128_64, -1); // addr , freq , SDA, SCL, resolution , rst
//SSD1306Wire  display(0x3c, 500000, 4, 15, GEOMETRY_128_64, -1); // addr , freq , SDA, SCL, resolution , rst
