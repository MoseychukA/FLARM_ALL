...
#define ADSB_ESP32_RX_PIN 2                 // Вход сигнала с приемника ADSB 1090 мГц
#endif

#ifndef ADSB_ESP32_OK_PULSE_PIN
#define ADSB_ESP32_OK_PULSE_PIN 4           // Индикатор расшифрованного пакета ADSB
#endif

#ifndef ADSB_ESP32_THRESHOLD_PWM_PIN
#define ADSB_ESP32_THRESHOLD_PWM_PIN 48     // Выход ШИМ порогового сигнала на компаратор
#endif

#ifndef ADSB_ESP32_THRESHOLD_PWM_CHANNEL
#define ADSB_ESP32_THRESHOLD_PWM_CHANNEL 7  // 
#endif

#ifndef ADSB_ESP32_DMA_CAPTURE
#define ADSB_ESP32_DMA_CAPTURE 0  
#endif
...
// Для работы I2S DMA требуются выходные контакты BCLK/WS, даже если считываются только данные с GPIO2.
// Эти контакты не подключены к компаратору ADS-B; оставьте их неиспользованными на печатной плате.
...
struct ADSBReceiverESP32Diag
{
    ...
    uint32_t softDecisionUsed;
    uint32_t weakBitRepaired;
