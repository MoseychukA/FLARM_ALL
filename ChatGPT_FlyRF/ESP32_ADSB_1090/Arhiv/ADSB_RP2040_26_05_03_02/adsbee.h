...
class ADSBee {
    ...
    */
    static inline int AD8313MilliVoltsTodBm(int mv)
    {
        ...
        static constexpr uint16_t kLNAGaindB = 12;    // Коэффициент усиления 2x LNA перед AD8313, полученный в ходе стендовых испытаний.
   ...
   */
   ...
   // uint16_t GetTLLearningTemperatureMV();
     ...
     */
    int ReadSignalStrengthMilliVolts();
