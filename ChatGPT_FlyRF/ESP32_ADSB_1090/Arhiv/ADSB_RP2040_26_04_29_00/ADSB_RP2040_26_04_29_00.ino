...
const int pwmPin = 9;
const int minDuty = 10; // ~0.3 V на выходе после фильтра при 3.3 V питании
const int maxDuty = 130; // ~1.6 V на выходе после фильтра
...
void setup() 
{
    ...
    analogWriteFreq(20000);   // частота PWM ~20 kHz
    analogWrite(pwmPin, 65/*minDuty*/); // стартовый уровень
    Serial.println("PWM control ready. Send voltage in mV (300-1400)");
...
// Если новое сообщение пришло:
 ...
 /*       Serial.print("Received ");
        ...
        // Преобразуем mv (300..1600) -> duty (minDuty..maxDuty)
