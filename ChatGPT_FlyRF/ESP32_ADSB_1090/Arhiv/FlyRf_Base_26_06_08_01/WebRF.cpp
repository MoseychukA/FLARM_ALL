...
static String outputsPage()
{
    ...
    html += F("</select></td></tr>");
    html += F("<tr><th>Serial ADSB ESP32S3 RX</th><td><select class='wLong hardwareCtl30 compactSelect' style='width:210px;min-width:210px;max-width:210px;' name='adsb_esp32_serial_out'>");
    html += String("<option ") + sel(!(settings && settings->adsb_esp32_serial_out)) + " value='0'>Off</option>";
    html += String("<option ") + sel(settings && settings->adsb_esp32_serial_out) + " value='1'>On</option>";
    html += F("</select></td></tr>");
...
static String outputsSavedPage()
{
    ...
    html += F("<tr><th>Serial ADSB ESP32S3 RX</th><td>"); html += yesNo(settings ? settings->adsb_esp32_serial_out : 0, "Off", "On"); html += F("</td></tr>");
...
static void handleHardwareLive()
{
    ...
    else
    {
        ...
        if (server.hasArg("adsb_esp32_serial_out")) settings->adsb_esp32_serial_out = (uint8_t)clampInt(server.arg("adsb_esp32_serial_out").toInt(), 0, 1);
