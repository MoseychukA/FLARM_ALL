...
void SystemSetup()
{
    ...
    RP2040Bridge_setup();
    RP2040BridgeDiag rp2040Diag = {};
    if (RP2040Bridge_getDiag(rp2040Diag))
    {
        Serial.println(F("[SETUP] RP2040 setup done"));
    }
    else
    {
        Serial.println(F("[SETUP] RP2040 setup skipped"));
    }

    ADSBReceiverESP32_setup();
    Serial.println(F("[SETUP] ESP32 ADS-B setup done"));
