...
static String rootPage()
{
    ...
    if (settings && settings->bluetooth != BLUETOOTH_OFF)
    {
        html += F(" / ");
        html += Bluetooth_name();
    }
...
static String outputsSavedPage()
{
    ...
    html += F("<tr><th>Bluetooth</th><td>"); html += bluetoothModeName(settings ? settings->bluetooth : BLUETOOTH_OFF); if (settings && settings->bluetooth != BLUETOOTH_OFF) { html += F(" / "); html += Bluetooth_name(); } html += F("</td></tr>");
