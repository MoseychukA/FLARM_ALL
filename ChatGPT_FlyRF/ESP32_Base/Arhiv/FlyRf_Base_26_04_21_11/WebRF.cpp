...
static uint32_t parseBlockAddrArg(const String& value)
{
    ...
    unsigned long parsed = strtoul(trimmed.c_str(), nullptr, 16);
...
static String blockAddrSummary()
{
    ...
    char addr2[16];
    char addr3[16];
    formatBlockAddr(addr1, sizeof(addr1), settings ? settings->block_addr : 0U);
    formatBlockAddr(addr2, sizeof(addr2), settings ? settings->block_addr2 : 0U);
    formatBlockAddr(addr3, sizeof(addr3), settings ? settings->block_addr3 : 0U);
...
static String hardwarePage()
{
    ...
    html += F("<tr><th>&#1041;&#1083;&#1086;&#1082;&#1080;&#1088;&#1086;&#1074;&#1072;&#1090;&#1100; &#1072;&#1076;&#1088;&#1077;&#1089; 1</th><td><input class='hardwareCtl60' type='text' name='block_addr' value='");
    html += blockAddr1;
    html += F("'></td></tr>");
    html += F("<tr><th>&#1041;&#1083;&#1086;&#1082;&#1080;&#1088;&#1086;&#1074;&#1072;&#1090;&#1100; &#1072;&#1076;&#1088;&#1077;&#1089; 2</th><td><input class='hardwareCtl60' type='text' name='block_addr2' value='");
    html += blockAddr2;
    html += F("'></td></tr>");
    html += F("<tr><th>&#1041;&#1083;&#1086;&#1082;&#1080;&#1088;&#1086;&#1074;&#1072;&#1090;&#1100; &#1072;&#1076;&#1088;&#1077;&#1089; 3</th><td><input class='hardwareCtl60' type='text' name='block_addr3' value='");
    html += blockAddr3;
    html += F("'></td></tr>");
...
static void handleHardwareLive()
{
    ...
    else
    {
        ...
        if (server.hasArg("block_addr")) settings->block_addr = parseBlockAddrArg(server.arg("block_addr"));
        if (server.hasArg("block_addr2")) settings->block_addr2 = parseBlockAddrArg(server.arg("block_addr2"));
        if (server.hasArg("block_addr3")) settings->block_addr3 = parseBlockAddrArg(server.arg("block_addr3"));
