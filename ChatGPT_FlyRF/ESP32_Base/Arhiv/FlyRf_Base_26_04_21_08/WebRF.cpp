...
static String outputsPage()
{
    ...
    html += F("</select></td></tr>");
    html += F("<tr><th>&#1057;&#1099;&#1088;&#1099;&#1077; LoRa RX &#1074; Serial</th><td><select class='wLong hardwareCtl30 compactSelect' style='width:210px;min-width:210px;max-width:210px;' name='raw_lora_serial'>");
    html += String("<option " ) + sel(!(settings && settings->raw_lora_serial)) + " value='0'>&#1042;&#1099;&#1082;&#1083;&#1102;&#1095;&#1080;&#1090;&#1100;</option>";
    html += String("<option " ) + sel(settings && settings->raw_lora_serial) + " value='1'>&#1042;&#1082;&#1083;&#1102;&#1095;&#1080;&#1090;&#1100;</option>";
    html += F("</select></td></tr>");
    html += F("<tr><th>&#1057;&#1099;&#1088;&#1099;&#1077; LoRa RX &#1085;&#1072; &#1076;&#1080;&#1089;&#1087;&#1083;&#1077;&#1081;</th><td><select class='wLong hardwareCtl30 compactSelect' style='width:210px;min-width:210px;max-width:210px;' name='raw_lora_tft'>");
    html += String("<option " ) + sel(!(settings && settings->raw_lora_tft)) + " value='0'>&#1042;&#1099;&#1082;&#1083;&#1102;&#1095;&#1080;&#1090;&#1100;</option>";
    html += String("<option " ) + sel(settings && settings->raw_lora_tft) + " value='1'>&#1042;&#1082;&#1083;&#1102;&#1095;&#1080;&#1090;&#1100;</option>";
    html += F("</select></td></tr>");
...
static String outputsSavedPage()
{
    ...
    html += F("<tr><th>&#1057;&#1099;&#1088;&#1099;&#1077; LoRa RX &#1074; Serial</th><td>"); html += onOffName(settings ? settings->raw_lora_serial : 0); html += F("</td></tr>");
    html += F("<tr><th>&#1057;&#1099;&#1088;&#1099;&#1077; LoRa RX &#1085;&#1072; &#1076;&#1080;&#1089;&#1087;&#1083;&#1077;&#1081;</th><td>"); html += onOffName(settings ? settings->raw_lora_tft : 0); html += F("</td></tr>");
...
static void handleOutputsLive()
{
    ...
    if (server.hasArg("serial_out")) settings->serial_out = (uint8_t)clampInt(server.arg("serial_out").toInt(), OUTPUT_MODE_OFF, OUTPUT_MODE_FLARM);
    if (server.hasArg("raw_lora_serial")) settings->raw_lora_serial = (uint8_t)clampInt(server.arg("raw_lora_serial").toInt(), 0, 1);
    if (server.hasArg("raw_lora_tft")) settings->raw_lora_tft = (uint8_t)clampInt(server.arg("raw_lora_tft").toInt(), 0, 1);
    if (server.hasArg("rs485_out")) settings->rs485_out = (uint8_t)clampInt(server.arg("rs485_out").toInt(), OUTPUT_MODE_OFF, OUTPUT_MODE_FLARM);
    if (server.hasArg("bluetooth")) settings->bluetooth = (uint8_t)clampInt(server.arg("bluetooth").toInt(), BLUETOOTH_OFF, BLUETOOTH_LE);
