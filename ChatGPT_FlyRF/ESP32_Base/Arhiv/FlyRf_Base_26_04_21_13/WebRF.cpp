...
static String blockAddrInputFilterScript(const char* inputName)
{
    ...
    s += inputName;
    s += F("\"]');if(!el)return;function norm(){var v=(el.value||'').toUpperCase().replace(/[^0-9A-F]/g,'').slice(0,6);if(el.value!==v)el.value=v;}el.addEventListener('input',norm);el.addEventListener('blur',norm);norm();})();</script>");
    return s;
}
...
static void formatBlockAddr(char* out, size_t outSize, uint32_t value)
{
    ...
    {
        snprintf(out, outSize, "%06lX", (unsigned long)value);
    }
}
...
static String blockAddrSummary()
{
    ...
    char addr2[16];
    char addr3[16];
    formatBlockAddrSummary(addr1, sizeof(addr1), settings ? settings->block_addr : 0U);
    formatBlockAddrSummary(addr2, sizeof(addr2), settings ? settings->block_addr2 : 0U);
    formatBlockAddrSummary(addr3, sizeof(addr3), settings ? settings->block_addr3 : 0U);
...
static String hardwarePage()
{
    ...
    char blockAddr2[16];
    char blockAddr3[16];
    formatBlockAddr(blockAddr1, sizeof(blockAddr1), settings ? settings->block_addr : 0U);
    formatBlockAddr(blockAddr2, sizeof(blockAddr2), settings ? settings->block_addr2 : 0U);
    formatBlockAddr(blockAddr3, sizeof(blockAddr3), settings ? settings->block_addr3 : 0U);
    html += F("<tr><th>&#1041;&#1083;&#1086;&#1082;&#1080;&#1088;&#1086;&#1074;&#1072;&#1090;&#1100; &#1072;&#1076;&#1088;&#1077;&#1089; 1</th><td><input class='hardwareCtl60' type='text' name='block_addr' maxlength='6' pattern='[0-9A-Fa-f]{6}' title='&#1042;&#1074;&#1077;&#1076;&#1080;&#1090;&#1077; 6 HEX-&#1089;&#1080;&#1084;&#1074;&#1086;&#1083;&#1086;&#1074;: 0-9 &#1080; A-F' placeholder='3BC002' autocomplete='off' spellcheck='false' value='");
    html += blockAddr1;
    html += F("'></td></tr>");
    html += F("<tr><th>&#1041;&#1083;&#1086;&#1082;&#1080;&#1088;&#1086;&#1074;&#1072;&#1090;&#1100; &#1072;&#1076;&#1088;&#1077;&#1089; 2</th><td><input class='hardwareCtl60' type='text' name='block_addr2' maxlength='6' pattern='[0-9A-Fa-f]{6}' title='&#1042;&#1074;&#1077;&#1076;&#1080;&#1090;&#1077; 6 HEX-&#1089;&#1080;&#1084;&#1074;&#1086;&#1083;&#1086;&#1074;: 0-9 &#1080; A-F' placeholder='3BC002' autocomplete='off' spellcheck='false' value='");
    html += blockAddr2;
    html += F("'></td></tr>");
    html += F("<tr><th>&#1041;&#1083;&#1086;&#1082;&#1080;&#1088;&#1086;&#1074;&#1072;&#1090;&#1100; &#1072;&#1076;&#1088;&#1077;&#1089; 3</th><td><input class='hardwareCtl60' type='text' name='block_addr3' maxlength='6' pattern='[0-9A-Fa-f]{6}' title='&#1042;&#1074;&#1077;&#1076;&#1080;&#1090;&#1077; 6 HEX-&#1089;&#1080;&#1084;&#1074;&#1086;&#1083;&#1086;&#1074;: 0-9 &#1080; A-F' placeholder='3BC002' autocomplete='off' spellcheck='false' value='");
    html += blockAddr3;
    html += F("'></td></tr>");
...
static void handleHardwareLive()
{
    ...
    else
    {
        ...
        if (server.hasArg("serial_out")) settings->serial_out = (uint8_t)clampInt(server.arg("serial_out").toInt(), OUTPUT_MODE_OFF, OUTPUT_MODE_LORA_RAW);
        ...
        uint32_t parsedBlockAddr = 0U;
        uint32_t parsedBlockAddr2 = 0U;
        uint32_t parsedBlockAddr3 = 0U;
        String normalizedBlockAddr;
        String normalizedBlockAddr2;
        String normalizedBlockAddr3;
        String blockAddrError;
        if (!readBlockAddrArg("block_addr", parsedBlockAddr, normalizedBlockAddr, blockAddrError) ||
            !readBlockAddrArg("block_addr2", parsedBlockAddr2, normalizedBlockAddr2, blockAddrError) ||
            !readBlockAddrArg("block_addr3", parsedBlockAddr3, normalizedBlockAddr3, blockAddrError))
        {
            sendNoCache();
        ...
        settings->block_addr = parsedBlockAddr;
        settings->block_addr2 = parsedBlockAddr2;
        settings->block_addr3 = parsedBlockAddr3;
