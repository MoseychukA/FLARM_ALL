...
static String settingsPage()
{
    ...
    html += F("<tr><th>&#1056;&#1077;&#1078;&#1080;&#1084; &#1088;&#1072;&#1073;&#1086;&#1090;&#1099;</th><td><select class='wLong settingsTopCtl50 compactSelect' style='width:200px;min-width:200px;max-width:200px;' name='mode'>");
...
static String hardwarePage()
{
    ...
    html += F("<tr><th>&#1041;&#1083;&#1086;&#1082;&#1080;&#1088;&#1086;&#1074;&#1072;&#1090;&#1100; &#1072;&#1076;&#1088;&#1077;&#1089;</th><td><input class='hardwareCtl60' type='text' name='block_addr' value='");
    html += blockAddr;
    html += F("'></td></tr>");
...
static String hardwareSavedPage(bool defaultsLoaded)
{
    ...
    html += F("<tr><th>&#1041;&#1083;&#1086;&#1082;&#1080;&#1088;&#1086;&#1074;&#1072;&#1090;&#1100; &#1072;&#1076;&#1088;&#1077;&#1089;</th><td>"); html += blockAddr; html += F("</td></tr>");
...
static void handleHardwareLive()
{
    ...
    else
    {
        ...
        if (server.hasArg("block_addr")) settings->block_addr = ((uint32_t)strtoul(server.arg("block_addr").c_str(), nullptr, 16)) & 0xFFFFFFUL;
        RemoveBlockedTrafficFromContainer();
