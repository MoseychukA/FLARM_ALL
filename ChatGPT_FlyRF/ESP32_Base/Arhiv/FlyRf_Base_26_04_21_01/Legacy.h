/*
  Модуль Legacy.h
  Назначение:
  - Описание констант и интерфейса старого радиопротокола.

  Что содержит файл:
  - Параметры преамбулы, syncword, размера полезной нагрузки и CRC.
  - Объявления функций кодирования и декодирования legacy-пакетов.
*/
