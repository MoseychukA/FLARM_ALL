...
static void applyRuntimeSettingsAfterSave(bool refreshCoordinates, bool refreshRp2040Gain)
{
    if (!settings) return;
...
static String settingsPage()
{
    ...
    html += F("<h1>&#1053;&#1072;&#1089;&#1090;&#1088;&#1086;&#1081;&#1082;&#1080;</h1><form id='settings_form' action='/input' method='GET' data-live='/settings_live'>");
    ...
    html += F(R"JS(<div id='settingsSaveInfo'></div><script>
(function(){
  var f=document.getElementById('settings_form');
  var box=document.getElementById('settingsSaveInfo');
  if(!f||!box||!window.fetch||!window.FormData||!window.URLSearchParams) return;
  f.addEventListener('submit', function(ev){
    ev.preventDefault();
    var btn=f.querySelector('button[type="submit"]');
    if(btn) btn.disabled=true;
    box.innerHTML="<div class='confirmTitle'>&#1057;&#1086;&#1093;&#1088;&#1072;&#1085;&#1103;&#1102;...</div>";
    var params=new URLSearchParams(new FormData(f));
    fetch((f.getAttribute('data-live')||f.getAttribute('action'))+'?'+params.toString(),{cache:'no-store'})
      .then(function(r){ return r.ok ? r.json() : Promise.reject(); })
      .then(function(data){
        if(!data||!data.ok) throw new Error('save');
        box.innerHTML="<div class='hr'></div><div class='confirmTitle'>&#1053;&#1072;&#1089;&#1090;&#1088;&#1086;&#1081;&#1082;&#1080; &#1089;&#1086;&#1093;&#1088;&#1072;&#1085;&#1077;&#1085;&#1099; &#1080; &#1087;&#1088;&#1080;&#1084;&#1077;&#1085;&#1077;&#1085;&#1099; &#1073;&#1077;&#1079; &#1087;&#1077;&#1088;&#1077;&#1079;&#1072;&#1075;&#1088;&#1091;&#1079;&#1082;&#1080;.</div>";
      })
      .catch(function(){
        box.innerHTML="<div class='hr'></div><div class='confirmTitle'>&#1054;&#1096;&#1080;&#1073;&#1082;&#1072; &#1089;&#1086;&#1093;&#1088;&#1072;&#1085;&#1077;&#1085;&#1080;&#1103;.</div>";
      })
...
static String hardwarePage()
{
    ...
    html += F("<h1>&#1040;&#1087;&#1087;&#1072;&#1088;&#1072;&#1090;&#1085;&#1099;&#1077; &#1085;&#1072;&#1089;&#1090;&#1088;&#1086;&#1081;&#1082;&#1080;</h1><form id='hardware_form' action='/hardware_input' method='GET' data-live='/hardware_live'>");
    ...
    html += F("'></td></tr>");
    html += F("</table></div><div class='btnRowEqual'><button class='btn' type='submit'><span class='btnIcon'>&#128190;</span>&#1057;&#1086;&#1093;&#1088;&#1072;&#1085;&#1080;&#1090;&#1100; &#1080; &#1086;&#1073;&#1085;&#1086;&#1074;&#1080;&#1090;&#1100;</button><a class='btn' href='/'><span class='btnIcon'>&#8634;</span>&#1042;&#1086;&#1079;&#1074;&#1088;&#1072;&#1090; &#1073;&#1077;&#1079; &#1089;&#1086;&#1093;&#1088;&#1072;&#1085;&#1077;&#1085;&#1080;&#1103;</a></div></form>");
    html += F(R"JS(<div id='hardwareSaveInfo'></div><script>
(function(){
  var f=document.getElementById('hardware_form');
  var box=document.getElementById('hardwareSaveInfo');
  if(!f||!box||!window.fetch||!window.FormData||!window.URLSearchParams) return;
  f.addEventListener('submit', function(ev){
    ev.preventDefault();
    var btn=f.querySelector('button[type="submit"]');
    ...
    fetch((f.getAttribute('data-live')||f.getAttribute('action'))+'?'+params.toString(),{cache:'no-store'})
      ...
      .then(function(data){
        if(!data||!data.ok) throw new Error('save');
        var msg=data.reset_defaults
          ? "&#1059;&#1089;&#1090;&#1072;&#1085;&#1086;&#1074;&#1082;&#1080; &#1087;&#1086; &#1091;&#1084;&#1086;&#1083;&#1095;&#1072;&#1085;&#1080;&#1102; &#1074;&#1086;&#1089;&#1089;&#1090;&#1072;&#1085;&#1086;&#1074;&#1083;&#1077;&#1085;&#1099; &#1080; &#1087;&#1088;&#1080;&#1084;&#1077;&#1085;&#1077;&#1085;&#1099; &#1073;&#1077;&#1079; &#1087;&#1077;&#1088;&#1077;&#1079;&#1072;&#1075;&#1088;&#1091;&#1079;&#1082;&#1080;."
          : "&#1040;&#1087;&#1087;&#1072;&#1088;&#1072;&#1090;&#1085;&#1099;&#1077; &#1085;&#1072;&#1089;&#1090;&#1088;&#1086;&#1081;&#1082;&#1080; &#1089;&#1086;&#1093;&#1088;&#1072;&#1085;&#1077;&#1085;&#1099; &#1080; &#1087;&#1088;&#1080;&#1084;&#1077;&#1085;&#1077;&#1085;&#1099; &#1073;&#1077;&#1079; &#1087;&#1077;&#1088;&#1077;&#1079;&#1072;&#1075;&#1088;&#1091;&#1079;&#1082;&#1080;.";
        box.innerHTML="<div class='hr'></div><div class='confirmTitle'>"+msg+"</div>";
      })
      .catch(function(){
        box.innerHTML="<div class='hr'></div><div class='confirmTitle'>&#1054;&#1096;&#1080;&#1073;&#1082;&#1072; &#1089;&#1086;&#1093;&#1088;&#1072;&#1085;&#1077;&#1085;&#1080;&#1103;.</div>";
      })
...
static String outputsPage()
{
    ...
    html += F("<h1>&#1059;&#1087;&#1088;&#1072;&#1074;&#1083;&#1077;&#1085;&#1080;&#1077; &#1074;&#1099;&#1074;&#1086;&#1076;&#1086;&#1084;</h1><form id='outputs_form' action='/outputs_save' method='GET' data-live='/outputs_live'><table>");
    ...
    html += F(R"JS(<div id='outputsSaveInfo'></div><script>
(function(){
  var f=document.getElementById('outputs_form');
  var box=document.getElementById('outputsSaveInfo');
  if(!f||!box||!window.fetch||!window.FormData||!window.URLSearchParams) return;
  f.addEventListener('submit', function(ev){
    ev.preventDefault();
    var btn=f.querySelector('button[type="submit"]');
    ...
    fetch((f.getAttribute('data-live')||f.getAttribute('action'))+'?'+params.toString(),{cache:'no-store'})
      ...
      .then(function(data){
        if(!data||!data.ok) throw new Error('save');
        box.innerHTML="<div class='hr'></div><div class='confirmTitle'>&#1055;&#1072;&#1088;&#1072;&#1084;&#1077;&#1090;&#1088;&#1099; &#1074;&#1099;&#1074;&#1086;&#1076;&#1072; &#1089;&#1086;&#1093;&#1088;&#1072;&#1085;&#1077;&#1085;&#1099; &#1080; &#1087;&#1088;&#1080;&#1084;&#1077;&#1085;&#1077;&#1085;&#1099; &#1073;&#1077;&#1079; &#1087;&#1077;&#1088;&#1077;&#1079;&#1072;&#1075;&#1088;&#1091;&#1079;&#1082;&#1080;.</div>";
      })
      .catch(function(){
        box.innerHTML="<div class='hr'></div><div class='confirmTitle'>&#1054;&#1096;&#1080;&#1073;&#1082;&#1072; &#1089;&#1086;&#1093;&#1088;&#1072;&#1085;&#1077;&#1085;&#1080;&#1103;.</div>";
      })
...
static void handleInput()
{
    if (settings)
    {
        ...
        applyRuntimeSettingsAfterSave(true, false);
        EEPROM_store();
    }
...
static void handleHardwareLive()
{
    ...
    {
        EEPROM_clear();
        applyRuntimeSettingsAfterSave(true, true);
        resetDefaults = true;
    }
    else
    {
        ...
        applyRuntimeSettingsAfterSave(false, true);
        EEPROM_store();
    }
...
void Web_setup()
{
    ...
    server.on("/settings_live", handleSettingsLive);
    server.on("/hardware_settings", handleHardwareSettings);
    server.on("/hardware_input", handleHardwareInput);
    server.on("/hardware_live", handleHardwareLive);
    server.on("/outputs", handleOutputs);
    server.on("/outputs_save", handleOutputsSave);
    server.on("/outputs_live", handleOutputsLive);
    server.on("/display_mode_live", handleDisplayModeLive);
