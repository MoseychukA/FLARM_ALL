...
static void setDefaultsBody()
{
    ...
    eeprom_block.field.settings.lan_state_view = 0;
    ...
    eeprom_block.field.settings.udp_port = 0;
}
...
void EEPROM_setup(void)
{
    ...
    if (settings != nullptr)
    {
        ...
        if (settings->lan_state_view != 0)
        {
            settings->lan_state_view = 0;
            changed = true;
        }
    }
