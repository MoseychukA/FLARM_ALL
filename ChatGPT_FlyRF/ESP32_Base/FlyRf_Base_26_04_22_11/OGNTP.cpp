...
static GPS_Position pos;  // Счетчик, индекс, позиция или номер элемента.
static OGN_TxPacket ogn_tx_pkt;  // Параметр геометрии, координаты, размера или угла.
static OGN_RxPacket ogn_rx_pkt;  // Параметр геометрии, координаты, размера или угла.
...
//  }
  ...
  uint8_t addr_type = ADDR_TYPE_ANONYMOUS;  // Параметр конфигурации интерфейса, адресации или выбранного режима.
#else
