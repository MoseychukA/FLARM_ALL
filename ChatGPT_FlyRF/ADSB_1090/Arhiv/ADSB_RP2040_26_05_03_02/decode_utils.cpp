...
int32_t AltitudeCodeToAltitudeFt(uint16_t altitude_code) 
{
    ...
    {
        // Все биты равны 0: Информация о высоте недоступна или недействительна.
