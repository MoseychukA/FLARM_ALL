...
static void UpdateAircraftSignalInfo(Aircraft1090* aircraft_ptr, const Decoded1090Packet& packet)
{
    ...
    Raw1090Packet raw_packet = packet.GetRaw();
    aircraft_ptr->last_message_signal_strength_dbm = raw_packet.sigs_dbm;
    aircraft_ptr->last_message_signal_quality_db = raw_packet.sigq_db;
}
...
bool AircraftDictionary::IngestIdentityReplyPacket(IdentityReplyPacket packet)  //Принять пакет ответа на идентификацию
{
    ...
    UpdateAircraftSignalInfo(aircraft_ptr, packet);
