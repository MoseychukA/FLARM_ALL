     ...
     switch (Protocol)
     {
      case RF_PROTOCOL_MAVLINK:
        switch (Plan)
        {
          case RF_BAND_RU:
          default:
            { BaseFreq=868800000; ChanSepar=200000; Channels=1; MaxTxPower = 22; Bandwidth = 125; } // MAVLink over LoRa
            break;
        }
        break;
      ...
      default:
        switch (Plan)
        {
          case RF_BAND_RU:
          default:
            { BaseFreq=868800000; ChanSepar=200000; Channels= 1; MaxTxPower = 22; Bandwidth = 125; } // OGNTP
            break;
        }
        break;
      }
