...
// Формирует строки таблицы целей для нового GL050001C0-40 renderer.
// Имя сохранено для совместимости с логикой исходного проекта.
void displayAllPlanes();
extern uint8_t set_view_range;  // Текущий временный ручной диапазон TFT; 0 = штатный авто/ручной режим из настроек.
