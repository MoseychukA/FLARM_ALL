...
void Bluetooth_setup()
{
    ...
    // Arduino-ESP32 3.x does not reliably copy the GAP name into advertising
    // data on every start. Set it explicitly so Android can identify display.
    g_advertising->setName(g_name);
