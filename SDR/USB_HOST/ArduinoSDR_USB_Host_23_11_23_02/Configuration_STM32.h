...
#define DATA_MEASURE_THRESHOLD                     1500    // через сколько миллисекунд обновлять показания
...
#define BUTTON_K1     PE3
#define BUTTON_K0     PE4
#define BUTTON_WK_AP  PA0

#define LED1_GREEN    PA6
#define LED2_RED      PA7
