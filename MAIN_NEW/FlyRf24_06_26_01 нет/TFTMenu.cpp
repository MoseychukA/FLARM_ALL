...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 void TFTMenuScreen::drawMessage(TFTMenu* menuManager, int count_message, int count_view)
 {
     ...
     */
     ...
     else if (len_Width1 > 27 && len_Width1 <= 55)
     {
         String mystring(msg);
         String myString0 = mystring.substring(0, 27);
         rows_mail.drawString(myString0, 0, 0);
         Serial.println(myString0);
 /*        int xx = 27;
         Serial.println(mystring[31], HEX);
         Serial.println(mystring[32], HEX);
         if (mystring[31] == 0xD0 || mystring[31] == 0xD1)
             xx = 31;*/
         String myString1 = mystring.substring(27, 55);
     ...
     else if (len_Width1 > 66)
     {
         ...
         rows_mail.drawString(myString1, 0, 16);
         Serial.println(myString1);
         String myString2 = mystring.substring(66, 99);
 ...
 /*    if (len_Width1 <= 32)
     ...
     else if (len_Width1 > 32 && len_Width1 <= 66)
     {
         ...
         if (mystring[31] == 0xD0 || mystring[31] == 0xD1)
             xx=31;
         String myString1 = mystring.substring(xx, 65);
         rows_mail.drawString(myString1, 0, 16);
         Serial.println(myString1);
     }
     else if (len_Width1 > 66)
