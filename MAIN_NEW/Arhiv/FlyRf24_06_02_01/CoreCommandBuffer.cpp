...
//!!++++++++++++++++++++++++++++++++++++++ Переделать ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
      ...
      //EEPROM.write(settings->mail[count_message][0], 1);
      //EEPROM.write(settings->mail[count_message][1], 1);
      //EEPROM.write(settings->mail[count_message][2], NumberMessage);
      ...
      //EEPROM.write(settings->mail[0][0], 1);
      //EEPROM.write(settings->mail[0][1], 1);
      //EEPROM.write(settings->mail[0][2], NumberMessage);

      //for (int i = 3; i < 100; i++)
      //{
      //    EEPROM.write(settings->mail[0][i], msg_tmp[i]);
      //}
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
      ...
      for (int i = 0; i < 128; i++)
      {
          EEPROM.write(settings->mail[i], 0xFF);
      }
  ...
  /*    for (int i = count_message-1; i < 100; i++)
      ...
      for (int i = 0; i < 128; i++)
      {
          uint16_t mail_tmp = EEPROM.read(settings->mail[i]);
         // pStream->print(EEPROM.read(settings->mail[i]),HEX);
          pStream->print(mail_tmp,HEX);
