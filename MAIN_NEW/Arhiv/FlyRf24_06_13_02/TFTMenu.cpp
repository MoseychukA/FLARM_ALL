...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 void TFTMenuScreen::ParsePacket(const byte* packet, int packetSize)
 {
     ...
     SerialOutput.print("PACKET Size: ");
     SerialOutput.println(packetSize);

     ToFlyRf receivedPacket;
     ...
     Serial.print("addr "); Serial.println(receivedPacket.addr,HEX);
     //Serial.print("mode "); Serial.println(receivedPacket.mode);


    // char str1[4];
    // strncpy(receivedPacket.Squawk,0,5);
    // receivedPacket.Squawk[5] = 0;
     Serial.print("Squawk "); Serial.println(receivedPacket.Squawk);
     //Serial.print("flight "); Serial.println(receivedPacket.strflight);
     Serial.print("altitude "); Serial.println(receivedPacket.altitude);
     Serial.print("speed "); Serial.println(receivedPacket.speed);
     Serial.print("course "); Serial.println(receivedPacket.track);
     Serial.print("vert_rate "); Serial.println(receivedPacket.vert_rate);

     Serial.print("latitude "); Serial.println(receivedPacket.lat,5);
     Serial.print("longitude "); Serial.println(receivedPacket.lon,5);
     Serial.print("signal_source "); Serial.println(receivedPacket.signal_source);
     Serial.print("seen "); Serial.println(receivedPacket.seen);
     Serial.print("pSignal "); Serial.println(receivedPacket.pSignal);
