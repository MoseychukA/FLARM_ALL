...
#define BUFFER_SIZE                     110    // Размер буфера входящих сообщений

#define DATA_MEASURE_THRESHOLD          800    // через сколько миллисекунд обновлять показания
#define DATA_FLASHING_ON               2000    // через сколько миллисекунд подсвечивать сообщение
#define DATA_FLASHING_OFF               200    // через сколько миллисекунд не подсвечивать сообщение
...
#define data_txt2 "ПОЧТА УДАЛЕНА"
...
#define MAIL_OFF_DELAY        600000ul     // время выключения подсветки экрана при бездействии, миллисекунд
...
#define Number_of_bytes_block            114    // кличество байт одного блока текстовых сообщений
