...
#define Number_of_bytes_block            128    // кличество байт одного блока текстовых сообщений
#define Number_of_bytes_time              12    // кличество байт блока времени текстовых сообщений
