  ...
  if (hw_info.model == SOFTRF_MODEL_SKYWATCH) {
    ...
    else 
    {
      ...
      if (has_axp2101) {
        ...
        axp_2xxx.enableVbusVoltageMeasure();
...
static void ESP32_loop()
{
 ...
 /*     Serial.print("getVbusVoltage1:"); Serial.print(axp_2xxx.getVbusVoltage()); Serial.println("mV");*/
     // MainScreen->setPowerVoltageAkk(axp_2xxx.getVbusVoltage()); // Контроль напряжения питания.
