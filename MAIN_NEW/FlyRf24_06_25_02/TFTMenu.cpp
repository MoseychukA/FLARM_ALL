...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 void TFTMenuScreen::drawMessage(TFTMenu* menuManager, int count_message, int count_view)
 {
     ...
     */
     ...
     char str_all_message[128];

     sprintf(str_all_message, "%s ", msg);



     //String mystring_len(str_all_message);      //convert char array to string here.

     //size_t len_msg = strlen(msg);

     //int len_msg = SettingsMail.getNumber_from_Message();

     //int len_msg = sizeof(msg);   // определить длину сообщения


     //int len_Width = tft_radar->textWidth(msg);                   // Returns pixel width of string in current font
     ...
     //if (len_Width1 <= 24)
     //{
     //    rows_mail.drawString(str_all_message, 0, 0);
     //    //rows_mail.pushToSprite(&back, 1, 29, TFT_BLACK);
     //}
     //else if (len_Width1 > 24 && len_Width1 <= 48)
     //{
     //    rows_mail.drawString(str_all_message, 0, 0);
     //    String mystring(str_all_message);
     //    String myString1 = mystring.substring(25, 48);
     //    rows_mail.drawString(myString1, 0, 16);
     //   // rows_mail.pushToSprite(&back, 1, 29, TFT_BLACK);
     //}
     //else if (len_Width1 > 48)
     //{
     //    rows_mail.drawString(str_all_message, 0, 0);
     //    String mystring(str_all_message);
     //    String myString1 = mystring.substring(25, 48);
     //    rows_mail.drawString(myString1, 0, 0);
     //    myString1 = mystring.substring(49, 72);
     //    rows_mail.drawString(myString1, 0, 32);
     //   // rows_mail.pushToSprite(&back, 1, 29, TFT_BLACK);
     //}
