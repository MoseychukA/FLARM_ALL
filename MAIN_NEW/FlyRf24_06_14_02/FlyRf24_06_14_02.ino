    ...
    if (TxPosUpdMarker == 0 || (millis() - TxPosUpdMarker) > 2000)
    {
        ...
        case 3:
            ...
            */
                ...
                fo.addr = 0x151DC8;
                fo.Squawk = 1521;
                memcpy(fo.flight, "AFL1118", sizeof(fo.flight));
...
//======================== Самолет №2 ================================================
            ...
            fo.addr = 0x151DA0;
            fo.Squawk = 2123;
            memcpy(fo.flight, "AFL2122", sizeof(fo.flight));
            ...
            */
            ...
            fo.addr = 0x151DCF;
            fo.Squawk = 2751;
            memcpy(fo.flight, "AFL1684", sizeof(fo.flight));
            ...
            */
            ...
            fo.addr = 0x155C11;
            fo.Squawk = 1501;
            memcpy(fo.flight, "SMD6405", sizeof(fo.flight));
