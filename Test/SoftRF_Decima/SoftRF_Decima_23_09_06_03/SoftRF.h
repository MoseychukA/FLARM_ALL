...
/*
 * Если вам нужно, чтобы SoftRF работал в беспроводном режиме
 * клиентский режим — укажите SSID/PSK вашей локальной точки доступа:
 *
 * #define MY_ACCESSPOINT_SSID "My_AP_SSID"
 * #define MY_ACCESSPOINT_PSK  "My_AP_PSK"
 *
 * Если встроенная точка доступа SoftRF недостаточно стабильна для вас, рассмотрите возможность
 * использовать «обратный» режим, когда ваш смартфон действует
 * в качестве точки доступа для устройства SoftRF в качестве клиента:
 *
...
/*
 * Значения по умолчанию для последовательного ввода-вывода.
 * Может быть переопределено кодом, специфичным для платформы.
 */
#if !defined(SERIAL_IN_BR) // Если SERIAL_IN_BR не определен
/*
 * 9600 — значение скорости передачи данных NMEA по умолчанию.
 * для большинства модулей GNSS
 * используется в проекте SoftRF
 */
...
AHRS является простейшей навигационной системой, предназначенной для сверхлёгких БПЛА,
радиус действия которых не превышает нескольких десятков километров.
*/
...
enum  // Тип воздушного судна или модели
{
