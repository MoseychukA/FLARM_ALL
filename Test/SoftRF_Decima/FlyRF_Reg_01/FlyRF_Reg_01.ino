...
void setup() {
  ...
  Serial.print("RegPaConfig1 = ");Serial.println(readReg(RegPaConfig),HEX);
  Serial.print("SX1276_RegPaDac1 = "); Serial.println(readReg(SX1276_RegPaDac), HEX);
  Serial.print("RegOcp1 = ");  Serial.println(readReg(RegOcp), HEX);
  ...
  Serial.print("RegPaConfig2 = ");Serial.println(readReg(RegPaConfig),HEX);
  Serial.print("SX1276_RegPaDac2 = "); Serial.println(readReg(SX1276_RegPaDac), HEX);
  Serial.print("RegOcp2 = ");  Serial.println(readReg(RegOcp), HEX);
  hw_info.rf = RF_setup();
 /* Serial.print("RegPaConfig3 = ");Serial.println(readReg(RegPaConfig),HEX);
  Serial.print("SX1276_RegPaDac3 = "); Serial.println(readReg(SX1276_RegPaDac), HEX);
  Serial.print("RegOcp3 = ");  Serial.println(readReg(RegOcp), HEX);*/
  ...
  writeReg(RegPaConfig, 0x80 | (20 - 5)); // BOOST (5..20dBm)
 // delay(50);
  writeReg(SX1276_RegPaDac, 0x87); // high power
 // delay(50);
  writeReg(RegOcp, 0x3b); // high power
  //delay(50);
  Serial.print("RegPaConfig = ");Serial.println(readReg(RegPaConfig),HEX);
  Serial.print("SX1276_RegPaDac = "); Serial.println(readReg(SX1276_RegPaDac), HEX);
  Serial.print("RegOcp = ");  Serial.println(readReg(RegOcp), HEX);
