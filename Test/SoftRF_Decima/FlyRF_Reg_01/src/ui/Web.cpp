...
#define WEB_RegPaConfig                                0x09 // common
#define WEB_RegOcp                                     0x0B // common
#define WEB_RegPaDac                                   0x4D
...
void handleRoot() {
  ...
  WebRegPaConfig = readReg(WEB_RegPaConfig);
  WebRegPaDac = readReg(WEB_RegPaDac);
  WebRegOcp = readReg(WEB_RegOcp);
 ...
 <table width=100%%>\
   <tr><th align=left>Packets</th>\
    <td align=right><table><tr>\
     ...
     <table width=100%%>\
 <tr><th align=left>RegPaConfig&nbsp;</th><td align=right>%X</td>\
     <th align=left>&nbsp;RegPaDac&nbsp;</th><td align=right>%X</td>\
     <th align=left>&nbsp;RegOcp&nbsp;</th><td align=right>%X</td>\
    </tr></table></td></tr>\
  </table>\
 <h1 align=center>Информация GNSS</h1>\
 <table width=100%%>\
 ...
 <table width=100%%>\
  <tr>\
    ...
    ESP32_USB_Serial.connected ? supported_USB_devices[ESP32_USB_Serial.index].last_name  : "N/A",
      ...
      WebRegPaConfig, WebRegPaDac, WebRegOcp,
