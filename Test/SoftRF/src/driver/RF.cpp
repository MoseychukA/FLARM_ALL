...
//  if (rf_chip == NULL) 
//  {
     #if !defined(USE_OGN_RF_DRIVER)//9
     #if !defined(EXCLUDE_SX12XX)//4
     #if !defined(EXCLUDE_SX1276)//1
        if (sx1276_ops.probe()) 
        {
            rf_chip = &sx1276_ops;
            #else
            ...
            #if defined(USE_BASICMAC) //3

            #if !defined(EXCLUDE_SX1276)//2
...
//      rf_chip = &sx1262_ops;
      SX12XX_LL = &sx126x_ll_ops;
       #endif //3 USE_BASICMAC 
       #else
        if (false) 
	    {
       #endif //4 EXCLUDE_SX12XX 
         
        // #if !defined(EXCLUDE_NRF905)//6
      //  }
//	//else if (nrf905_ops.probe()) 
//	//{
//     // rf_chip = &nrf905_ops;
//     // #endif // EXCLUDE_NRF905 //6
//	  
//      #if !defined(EXCLUDE_UATM)7
//    //}
//	else if (uatm_ops.probe()) 
//	{
//      rf_chip = &uatm_ops;
//    #endif //7 EXCLUDE_UATM 
//#if !defined(EXCLUDE_CC13XX)//8
//    } else if (cc13xx_ops.probe()) {
//      rf_chip = &cc13xx_ops;
//#endif //8 EXCLUDE_CC13XX 
//
//    }
//	
...
//
        ...
        /* Supersede EU plan with UK when PAW is selected */
            if (rf_chip && settings->rf_protocol == RF_PROTOCOL_P3I) 
	        {
