...
void setup()
{
  ...
  //============================================================================
    ...
    //xTaskCreatePinnedToCore(rxTask, "RX", 8192, NULL, 2, NULL, 0);              // Прием пакетов с базы
    //xTaskCreatePinnedToCore(linkWatchdogTask, "LINK", 1024, NULL, 1, NULL, 0);  // Контроль соединения с базой
    //xTaskCreatePinnedToCore(buttonMTask, "ButtonM", 8192, NULL, 1, NULL, 0);    // быстрая задача: немедленная отправка new_buttton_M от AuxData
    //xTaskCreatePinnedToCore(ButtonTask, "BtnTask", 4096, NULL, 1, NULL, 0);     // Обработка кнопок
     
    xTaskCreatePinnedToCore(rxTask, "RX", 8192, NULL, 2, &Task1, 0);              // Прием пакетов с базы
    ...
    xTaskCreatePinnedToCore(ButtonTask, "BtnTask", 4096, NULL, 1, &Task4, 0);     // Обработка кнопок
