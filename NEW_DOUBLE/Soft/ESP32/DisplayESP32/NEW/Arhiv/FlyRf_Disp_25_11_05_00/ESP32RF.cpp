...
static void drawMessage()
{
    ...
    rows_Message.deleteSprite();
    //back.pushSprite(0, 0);
    //strncpy(msg_mem, "", strlen(msg_mem));
...
static void clearMSG()
{
  ...
  /*      back.pushSprite(0, 0);*/
   ...
   // strncpy(service.msg_tmp_all, 0, Number_of_bytes_block /*strlen(service.msg_tmp_all)*/);
...
static void ESP32_Display_loop()
{
    ...
    { 
      ...
      //         // Serial.println(service.msg_tmp_all);

      //          strncpy(service.msg_tmp_all, "", strlen(service.msg_tmp_all) + 2);         // Очистить буфер сообщения
      //          clearPlaneDisplay();
      //         // showMessage();                                                           // вызвать программу отображения информации на дисплее
      //      }

            ////===================== Мигание текстового сообщения ===========================
            ...
            //        if (isMessageVisible && now - lastToggle >= showPeriod)
            //        {
            //            hideMessage();
            //            isMessageVisible = false;
            //            lastToggle = now;
            //        }
            //        else if (!isMessageVisible && now - lastToggle >= hidePeriod)
            //        {
            //            showMessage();
