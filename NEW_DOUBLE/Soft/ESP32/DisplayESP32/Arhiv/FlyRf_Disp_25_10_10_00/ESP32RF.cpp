...
static void ESP32_Display_loop()
{
    ...
    { /* TFT_display_frontpage  Основная программа отображения воздушной обстановки*/ 
        ...
        uint8_t set_view_range = service.get_view_range();
        ...
        if (set_view_range != 0)
        {
            ...
            if (millis() - button_tmr > BUTTON_OFF_DELAY)
            {
                button_tmr = millis();
                set_view_range = 0;
                service.set_view_range(set_view_range);
            }
        }
        ...
        if (new_buttton != 0)
        {
          //  count_buttton_tmp = 0;
            ...
            case 2:
               ...
               // set_view_range = service.get_view_range();
                set_view_range++;
                if (set_view_range > 6)
                {
                    set_view_range = 0;
        ...
        if (millis() - tmr > DATA_MEASURE_THRESHOLD)
        {
          ...
          //  set_view_range = service.get_view_range();
            ...
            Serial.printf("Page %d", set_view_range);
