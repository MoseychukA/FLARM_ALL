...
void printThisAircraft(const ufo_net_t* ac) 
{
 ...
 /*   Serial.print(":"); Serial.print(ac->addr);
    ...
    Serial.print(":"); Serial.print(ac->callsigncourse);
    Serial.print(":"); Serial.print(ac->speed);
    Serial.print(":"); Serial.print(ac->vert_rate);
    Serial.print(":"); Serial.print(ac->latitude, 7);
    Serial.print(":"); Serial.print(ac->longitude, 7);
...
void setup()
{
  ...
  xTaskCreatePinnedToCore(rxTask, "RX", 8192, NULL, 2, NULL, 0);
  xTaskCreatePinnedToCore(buttonsTask, "BTN", 2048, NULL, 1, NULL, 0);
  xTaskCreatePinnedToCore(replyTask, "REPLY", 2048, NULL, 1, NULL, 0);
  xTaskCreatePinnedToCore(linkWatchdogTask, "LINK", 1024, NULL, 1, NULL, 0);
...
void loop()
{
    ...
    if (settings->serial_out == SEND_SERIAL_INFO)
    {
        ...
        if (packetUpdated && millis() - tmr > 1000)
        {
            tmr = millis();
            packetUpdated = false;
