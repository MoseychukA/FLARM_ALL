...
void  ServiceClass::set_voltage_value(float value)
{
	voltage_value = value;

}
float  ServiceClass::get_voltage_value()
{
	return voltage_value;

}

void  ServiceClass::set_current_value(float current)
{
	current_value = current;

}
float  ServiceClass::get_current_value()
{
