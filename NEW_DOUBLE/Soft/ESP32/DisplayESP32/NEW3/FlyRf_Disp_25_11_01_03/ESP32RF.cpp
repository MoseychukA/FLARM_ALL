...
//            airplane_info[i]->drawString(String("Flight: ") + Container[i].callsign, 4, 2, 2);
...
//void addOrUpdatePlane(int idx, const char* callsign, uint32_t addr, int alt, int spd, float lat, float lon) {
//    strncpy(Container[idx].callsign, callsign, sizeof(Container[idx].callsign) - 1);
//    Container[idx].callsign[sizeof(Container[idx].callsign) - 1] = 0;
