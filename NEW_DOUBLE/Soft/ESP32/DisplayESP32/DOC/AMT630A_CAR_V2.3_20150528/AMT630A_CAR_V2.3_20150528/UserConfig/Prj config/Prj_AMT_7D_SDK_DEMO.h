...
#define P_MEX070TM_50D_DHV_AMT630A_20141113_EN   	ENABLE
...
#define MAINMENU_START_X_POS   			0X014C      //MAIN MENU 菜单的X起始位置
#define MAINMENU_START_Y_POS   			0X01BA     //MAIN MENU 菜单的Y起始位置

#define SOURCEMENU_START_X_POS 			0X032A   //SOURCE MENU 菜单的X起始位置
#define SOURCEMENU_START_Y_POS 			0X001C   //SOURCE MENU 菜单的Y起始位置

#define SOURCE_43_START_X_SHIFT          0X65      //SOURCE MENU 菜单4:3模式 与16:9模式的X差值

#define NOSIGNALMENU_START_X_POS 		0x014B   //NOSIGNAL MENU 菜单的X起始位置
#define NOSIGNALMENU_START_Y_POS 		0x00E2   //NOSIGNAL MENU 菜单的Y起始位置
...
#define DEFAULT_LANGUAGE        			JAPANESE//CHINESE//ENGLISH  //OSD 默认语言
