...
<tr>\
<th align=left>Вывод информации с приемника 1090</th>\
<td align=right>\
<select name='display_set'>\
<option % s value = '%d'>Нет вывода</option>\
<option % s value = '%d'>Сокращенная</option>\
<option % s value = '%d'>Полная</option>\
</select>\
</td>\
</tr>\
<tr>\
...
(settings->display_set == INFO_DISPLAY_MINI ? "selected" : ""), INFO_DISPLAY_MINI,
