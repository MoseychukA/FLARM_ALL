...
// GL050001C0-40 is a raw RGB565 panel and needs 21 unique ESP32-S3 signals:
// DE, VSYNC, HSYNC, PCLK, BL and 16 data lines. With the current FlyRF pinout
// there are not enough free exposed GPIOs after preserving RS485, power control,
// buttons, GNSS, SPI and I2C. Enable this module only after moving peripherals
// and filling the pin map below with unique, valid GPIO numbers.
#ifndef GL050001C0_40_PINMAP_CONFIRMED
#define GL050001C0_40_PINMAP_CONFIRMED 0
#endif

#if GL050001C0_40_PINMAP_CONFIRMED
static const int LCD_PIN_DE = -1;
static const int LCD_PIN_VSYNC = -1;
static const int LCD_PIN_HSYNC = -1;
static const int LCD_PIN_PCLK = -1;
static const int LCD_PIN_BL = -1;
