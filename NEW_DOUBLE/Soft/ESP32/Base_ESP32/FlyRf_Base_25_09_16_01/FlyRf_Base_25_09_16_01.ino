...
#define TX_PERIOD_MS 330  // 33 Гц; при необходимости увеличить/уменьшить
//#define TX_PERIOD_MS 100  // 10 Гц; при необходимости увеличить/уменьшить

//typedef struct UFO_S {
//    time_t    timestamp;
//    uint32_t  addr;
//    uint8_t   addr_type;
//    float     latitude;
...
void loop()
{
 ...
 // case FLYRF_MODE_TXRX_TEST0:
  ...
  if (currentMillis - previousMillis >= interval)
  {
      ...
      //AuxFlags.isValidGNSS_M = ledState;
      //analog_code_M = random(15, 96);
  }



 // analog_code_M = (uint16_t)service.battery_read();
