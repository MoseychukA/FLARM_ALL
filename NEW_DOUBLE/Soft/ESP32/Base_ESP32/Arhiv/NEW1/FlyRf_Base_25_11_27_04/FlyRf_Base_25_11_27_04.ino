...
void rxTask_test()
{
    ...
    yield(); // vTaskDelay(pdMS_TO_TICKS(20));
}
...
void printAux(const aux_t* aux)
{
    ...
    yield(); // vTaskDelay(pdMS_TO_TICKS(4));
}
...
void setup()
{
    ...
    heap_caps_malloc_extmem_enable(12000); //Use PSRAM for memory requests larger than 1,000 bytes
