...
bool Traffic_Add(ufo_t *fop)
{
  ...
  if (fo.distance > 60000.0) // Расттояние больше 60 км - удалить из базы.
  {
      fo.addr = 0;
      fo = EmptyFO;
      return false;
  ...
  /*        Container[i] = fo;*/
          ...
          Serial.print("ICAO: "); Serial.print(Container[i].addr, HEX);
          Serial.print(":"); Serial.print(Container[i].Squawk);
          Serial.print(":"); Serial.print(Container[i].flight);
          Serial.print(":"); Serial.print(Container[i].altitude);
          Serial.print(":"); Serial.print(Container[i].speed);
          Serial.print(":"); Serial.print(Container[i].course);
          Serial.print(":"); Serial.print(Container[i].vert_rate);
          Serial.print(":"); Serial.print(Container[i].latitude, 5);
          Serial.print(":"); Serial.print(Container[i].longitude, 5);
          Serial.print(":"); Serial.print(ThisAircraft.latitude, 5);
          Serial.print(":"); Serial.print(ThisAircraft.longitude, 5);
  ...
  if (fo.distance < Container[max_dist_ndx].distance && fo.alarm_level >= Container[max_dist_ndx].alarm_level)
  {
