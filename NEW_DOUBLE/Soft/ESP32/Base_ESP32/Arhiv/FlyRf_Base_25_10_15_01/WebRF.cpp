...
<option % s value = '%d'>Только новые</option>\
  ...
  (settings->tracker_send == GSM_SEND_OFF ? "selected" : ""), GSM_SEND_OFF,
  (settings->tracker_send == GSM_SEND_SINGLE ? "selected" : ""), GSM_SEND_SINGLE,
  (settings->tracker_send == GSM_SEND_AUTO ? "selected" : ""), GSM_SEND_AUTO,
  (settings->tracker_send == GSM_SEND_MINI ? "selected" : ""), GSM_SEND_MINI
  );
