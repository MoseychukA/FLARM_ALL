...
void Module1090::ParsePacket(const byte* packet, int packetSize)
{
   ...
   // fo.course = receivedPacket.course;               // Курс в градусах 
   ...
   // }
    ...
    //Serial.println("Hex , Squawk, Flight, alt , pres alt, speed, course, vert_rate,   latitude   ,    lon   , air_type, Ti");
    //Serial.println("--------------------------------------------------------------------------------------------");
...
void Module1090::update()
{
 /*   if (settings->d1090 == D1090_UART_MINI || settings->d1090 == D1090_UART_FULL)
    {*/
        ...
        //            //Serial.print("Track: "); Serial.println(packet.course);
