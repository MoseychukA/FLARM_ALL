...
// ============== Задачи (ядро 0) нужно редактировать!! не применять в этой версии ========================
...
void DataGenTask(void* arg) 
{
    ...
    for (;;) {
       ...
       // AuxFlags.SOS_View_on_off_M = digitalRead(SOC_GPIO_PIN_SOS);   // Получить признак состояния кнопки SOS;
...
void loop()
{
 ...
 // case FLYRF_MODE_TXRX_TEST0:
  ...
  //    Serial.printf("AuxFlags.SOS_View_on_off_M %d \r\n", AuxFlags.new_SOS_flag_M);
  //}
