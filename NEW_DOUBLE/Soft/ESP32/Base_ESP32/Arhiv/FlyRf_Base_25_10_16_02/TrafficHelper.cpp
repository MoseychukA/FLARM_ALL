...
// Ќасто€щий, безопасный вариант:
bool Traffic_Add(ufo_t* fop)
{
    int i;
    // 0. Ќе добавл€ем "пустые" данные (addr == 0)
    if (!fo.addr) return false;

    // 1. ѕроверка на существование такого addr Ч обновление
    ...
    // 3. ѕоиск самого старого, если все зан€ты (или просроченного)
    int oldest = 0;
    ...
    for (i = 1; i < MAX_TRACKING_OBJECTS; i++) 
    {
        ...
        // ≈сли требуетс€, вариант с "устаревшим"
