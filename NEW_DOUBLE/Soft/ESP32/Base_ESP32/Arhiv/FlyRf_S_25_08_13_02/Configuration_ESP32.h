...
#define BLOCK_SIZE 20                // Уменьшен размер блока для надежности
#define MAX_RETRIES 3                // Максимальное количество повторов
#define TRANSMISSION_TIMEOUT 2000    // Таймаут передачи в мс
