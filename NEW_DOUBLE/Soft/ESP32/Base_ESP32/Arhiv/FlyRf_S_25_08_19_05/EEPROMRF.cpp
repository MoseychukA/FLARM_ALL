...
void EEPROM_defaults()
{
  ...
  eeprom_block.field.settings.akk_min     = 3.20;         // Минимальное значение заряда аккумулятора
  eeprom_block.field.settings.akk_max     = 4.20;         // Максимальное значение заряда аккумулятора
  eeprom_block.field.settings.akk_koef    = 3.3;           // Коэффициет пересчета заряда аккумулятора
