...
// MODBUS конфигурация
#define SLAVE_ID 1
#define BAUD_RATE 115200  // 460800  // Увеличена скорость до максимальной для ESP32
#define MAX_MODBUS_BLOCK 123  // Максимальный размер блока для MODBUS RTU (по стандарту)
#define TRANSMISSION_INTERVAL 500  // Полный цикл обмена за 0.5 секунды
#define INTER_COMMAND_DELAY 10     // Минимальная задержка между командами
