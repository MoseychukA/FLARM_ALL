...
static void ESP32_setup()
{
  ...
  //SERIAL_TRACKER.begin(SERIAL_TRACKER_SPEED, EspSoftwareSerial::SWSERIAL_8N1, SOC_GPIO_PIN_TRACKER_RX, SOC_GPIO_PIN_TRACKER_TX);
...
static void ESP32_Display_loop()
{
    ...
    { /* TFT_display_frontpage  Основная программа отображения воздушной обстановки*/ 
        ...
        if (millis() - tmr > DATA_MEASURE_THRESHOLD)
        {
            ...
            service.set_GNSS_on_off(text_call);
            ...
            if (settings->akk_view == VIEW_AKK_ON)
            {
                ...
                service.set_analog_value(val_x);
