...
void handleSettings() // Основные настройки
{
...
//===
void hardwareSettings() //Аппаратные настройки
{
    //hardware_settings
    size_t size = 5900;
    char* offset;
...
<td align = right>\
<INPUT type = 'number' name = 'akk_min' min = '2.60' max = '3.70' step = '0.01' value = '%.02f'>\
</td>\
</tr>\
<tr>\
<th align=left>Максимальное значение заряда аккумулятора</th>\
<td align=right>\
<INPUT type='number' name='akk_max' min='3.30' max='4.50' step = '0.01' value='%.02f'>\
</td>\
</tr>\
<tr>\
...
(settings->out_of_sync == OUT_OF_SYNC_ON ? "selected" : ""), OUT_OF_SYNC_ON,
 settings->block_addr, settings->freq_corr, settings->akk_min, settings->akk_max,
 settings->akk_koef
);
len = strlen(offset);
offset += len;
...
//</head>\
//<body>\
//<h1 align=center>Настройки LoRa</h1>\
//<form action='/input' method='GET'>\
//<table width=100%%>\
//<tr>\
//<th align=left>Mode</th>\
...
<tr><th align=left>Минимальное значение заряда аккумулятора</th><td align=right>%.2f</td></tr>\
<tr><th align=left>Максимальное значение заряда аккумулятора</th><td align=right>%.2f</td></tr>\
