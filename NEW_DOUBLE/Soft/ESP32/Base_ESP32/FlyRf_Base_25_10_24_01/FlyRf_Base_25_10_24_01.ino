...
bool receivePacket_RS485(full_packet_t* pkt, uint8_t* btn1, uint8_t* btn2);
...
void setup()
{
    ...
    xTaskCreatePinnedToCore(txTask, "TX", 4096, NULL, 2, NULL, 0);
