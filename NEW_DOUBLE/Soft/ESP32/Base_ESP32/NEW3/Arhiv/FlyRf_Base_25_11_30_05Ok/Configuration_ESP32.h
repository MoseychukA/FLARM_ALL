...
#define BUFFER_SIZE                    370     // Размер буфера входящих сообщений
...
#define DATA_FLASHING_ON               3000    // через сколько миллисекунд подсвечивать сообщение
...
#define Number_of_bytes_block             370// 114    // кличество байт одного блока текстовых сообщений
