#include "uat_packet.h"

#include <cstring>  // for strlen
#include <numbers>

#include "aircraft_dictionary.h"  // for Aircraft::kAddressQualifierBitShift
#include "comms.h"                // for CONSOLE_INFO, CONSOLE_ERROR
#include "fec.h"
#include "fixedmath/fixed_math.hpp"
#include "geo_utils.h"
#include "buffer_utils.h"  // for CHAR_TO_HEX
...
const fixedmath::fixed_t kDegPerTrackAngleHeadingTick = fixedmath::fixed_t{360.0f / 512};  // Direction ticks for Track Angle / Heading field (UAT Tech Manual Table 3-24).
const fixedmath::fixed_t kDegPerRadian = fixedmath::fixed_t{180.0f / std::numbers::pi};  // Conversion factor from radians to degrees.
