...
struct DecodedInfo { uint8_t df; uint32_t icao; char callsign[9]; bool has_pos; double lat, lon; bool has_vel; double gs, trk; int alt; };
...
bool decode_velocity_tc19(const uint8_t* me, double& gs, double& trk);
