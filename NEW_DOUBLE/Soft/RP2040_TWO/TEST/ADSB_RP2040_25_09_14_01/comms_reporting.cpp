...
bool CommsManager::UpdateReporting() 
{
   ...
   //         default:
   //            // comms_manager.console_printf("CommsManager::UpdateReporting Invalid reporting protocol %d specified for interface %d.", reporting_protocols_[i],i);
   //             ret = false;
   //             break;
   //     }
   //    // comms_manager.console_printf("CommsManager::UpdateReporting Invalid");
   // }
