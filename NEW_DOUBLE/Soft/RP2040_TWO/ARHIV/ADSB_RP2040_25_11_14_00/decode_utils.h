...
static uint8_t extractDigit(uint16_t code, int startBit);



/**
* Переносит широту южного полушария, полученную в результате декодирования CPR. Преобразует широту из [270, 360] в [-90, 90].
* @param[in] широта Широта в градусах.
* @retval Перенесенная широта.
*/
