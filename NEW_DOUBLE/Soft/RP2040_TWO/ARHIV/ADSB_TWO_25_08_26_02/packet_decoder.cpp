...
bool PacketDecoder::UpdateDecoderLoop() 
{
    ...
    for (uint16_t i = 0; i < num_packets_to_process; i++)
    {
        ...
        //if (decoded_packet.GetDownlinkFormat() == 17 || decoded_packet.GetDownlinkFormat() == 5 || decoded_packet.GetDownlinkFormat() == 18 || decoded_packet.GetDownlinkFormat() == 19 || decoded_packet.GetDownlinkFormat() == 4)
        //{
