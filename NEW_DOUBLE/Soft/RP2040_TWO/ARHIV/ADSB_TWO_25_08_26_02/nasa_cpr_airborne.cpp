...
bool NASACPRDecoder::DecodeAirborneLocalCPR(const DecodedPosition &reference_position, const CPRMessage &message, DecodedPosition &decoded_position) 
{
...
bool NASACPRDecoder::DecodeAirborneGlobalCPR(const CPRMessage &even_message, const CPRMessage &odd_message, DecodedPosition &decoded_position) 
{
    ...
    struct recovered_position result =  global_dec(odd_message.received_timestamp_ms > even_message.received_timestamp_ms,
