...
public:
   ...
   // bool UpdateNetworkConsole();
    ...
    //void SendESP32(char* buf, uint16_t buf_len) 
    //{
    //    size_t len = buf_len;
    //    memcpy(message_buffer, buf, len);
    //    message_len_bytes = len;
    //    message_ready = true; // сигнал о новом сообщении
    //}
    ...
    void SendBuf(SettingsManager::SerialInterface iface, char *buf, uint16_t buf_len) 
    {
      ...
      //  message_ESP = true; // сигнал о новом сообщении
    }
