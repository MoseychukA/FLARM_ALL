...
struct Config{
  int profile; bool output_raw; int out_format; 
  ...
  // width filter thresholds (us)
  float w_short_us; float w_long_us; // valid if w_short<=width<=w_long
};

// Return bitmask: bit0=message enqueued, bit1=preamble detected
