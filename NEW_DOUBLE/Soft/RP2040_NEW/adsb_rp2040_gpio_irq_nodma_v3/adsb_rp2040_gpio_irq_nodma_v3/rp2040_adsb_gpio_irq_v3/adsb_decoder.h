...
struct DecodedFrame{ uint32_t icao; char callsign[9]; int squawk; float lat,lon; int altitude_m_geo; int altitude_m_baro; int speed_kmh; int track_deg; int vert_rate_mpm; uint32_t seen_time_ms; int aircraft_type; int src_type; int vr_mpm; int baro_geo_diff_m; bool pos_surface; };
