...
class CommsManager 
{
   public:
    ...
    static constexpr uint16_t kNetworkConsoleReportingIntervalOverrideNumChars =  kNetworkConsoleBufMaxLen * 3 /
...
#include "comms_reporting.h"
     ...
     */
    inline bool SetReportingProtocol(SettingsManager::SerialInterface iface, SettingsManager::ReportingProtocol protocol) 
	{
     ...
     */
    inline bool GetReportingProtocol(SettingsManager::SerialInterface iface, SettingsManager::ReportingProtocol &protocol) 
	{
