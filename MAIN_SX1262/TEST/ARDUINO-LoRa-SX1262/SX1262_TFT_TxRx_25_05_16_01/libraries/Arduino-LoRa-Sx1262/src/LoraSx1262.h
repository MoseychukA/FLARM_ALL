...
#define SX1262_NSS   46
#define SX1262_RESET 5
...
class LoraSx1262 {
  public:
    ...
    int lora_receive_rssi(); //"Среднее значение RSSI за последний полученный пакет. Фактическая мощность сигнала –RssiPkt/2 (дБм)"
    int lora_receive_snr();
    int lora_receive_signalRssi();
